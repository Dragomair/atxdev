...
public class ProgressBar extends JFrame {
	...
	/**
	 * Sets the Ataratix icon for bar
	 */
	private void setIcon() {
		...
		if (update) {
			Image bimg = Toolkit.getDefaultToolkit().getImage(url);
	...
	public ProgressBar() {
		...
		this.setTitle("Ataratix Updater");
		...
		addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent we) {
				int option = JOptionPane.showConfirmDialog(null, "Are you sure you want to cancel the download?",
