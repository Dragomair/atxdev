...
public class SettingHandler {
	 ...
	 */
	public final static String[] strings = { "Tweening", "Fog", "HD Minimap", "Mip Mapping", "Ground Decoration",
			"Moving Textures", "Status Orbs", "Roofs", "Money Pouch", "Kill Feed", "Hover Menus", "Entity Feed (N/A)",
			"Context Menu", "HP Bars", "Hitmarkers", "x10 Damage", "Camera Gliding", "Attack Priority", "Time Stamps",
			"Snow", "Prestige Colors", };
