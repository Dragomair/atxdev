public final class Floor {
	 ...
	 * stream.readUnsignedByte(); if (i == 0) { return; } else if(i == 1) { anInt390
	 * = stream.read3Bytes(); if (Configuration.snow) { anInt390 = 0xffffff; }
	 * method262(anInt390); } else if(i == 2) anInt391 = stream.readUnsignedByte();
	 * else if (i == 3) {
	 * 
	 * } else if(i == 5) aBoolean393 = false; else if (i == 6) stream.readString();
	 * else if(i == 7) { int j = anInt394; int k = anInt395; int l = anInt396; int
	 * i1 = anInt397; int j1 = stream.read3Bytes(); method262(j1); anInt394 = j;
	 * anInt395 = k; anInt396 = l; anInt397 = i1; anInt398 = i1; } else {
	 * System.out.println("Error unrecognised config code: " + i); } } while(true);
	 * }
	 */
