	...
	public Model getRotatedModel() {
		...
		if (!aBoolean1567) {
			...
			if (Configuration.enableTweening && nextAnimFrameId != -1) {
				model_1.interpolateFrames(j, aSpotAnim_1568.aAnimation_407.anIntArray353[nextAnimFrameId], anInt1570,
						aSpotAnim_1568.aAnimation_407.anIntArray355[anInt1569]);
			} else {
				model_1.method470(j);
			}
