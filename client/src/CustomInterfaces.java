...
public class CustomInterfaces extends RSInterface {
	 ...
	 * @param Ataratix
	 */
	public static void unpackInterfaces(TextDrawingArea[] Ataratix) {
		...
		/*
		 * The quest tab interface (Handles important information of server & player)
		 */
		 ...
		 */
		equipmentTab(Ataratix);
		equipmentScreen(Ataratix);

		/*
		 * Quick prayer & curses
		 */
		quickCurses(Ataratix);
		quickPrayers(Ataratix);
		...
		/*
		 * Handles teleporting to various locations around Ataratix
		 */
		trainingTeleport(Ataratix);
		skillingTeleport(Ataratix);
		pvpTeleport(Ataratix);
		bossTeleport(Ataratix);
		minigameTeleport(Ataratix);
		otherTeleport(Ataratix);
		 ...
		 */
		warriorGuild(Ataratix);

		/*
		 * Handles displaying information on the Pest Control minigame
		 */
		pestControlBoat(Ataratix);
		pestControlGame(Ataratix);

		/*
		 * Handles Player Profiler interface
		 */
		playerProfiler(Ataratix);
		myProfile(Ataratix);
		profileTab(Ataratix);
		profileLeaderboards(Ataratix);
		 ...
		 * Loyalty title
		 */
		loyaltyShop(Ataratix);

		/**
		 * Quest interface
		 */
		questInterface(Ataratix);
		...
		/*
		 * The clan chat interface & tab (Handles all the main functions of clan chat)
		 */
		clanChatTab(Ataratix);
		clanChatSetup(Ataratix);
		 ...
		 * Tab Creation
		 */
		tabCreation(Ataratix);

		/**
		 * Report Abuse
		 */
		reportAbuse(Ataratix);

		/**
		 * Bolt enchanting
		 */
		boltEnchanting(Ataratix);

		/**
		 * Weapon Game
		 */
		weaponLobby(Ataratix);
		weaponGame(Ataratix);
		weaponStore(Ataratix);

		/**
		 * Bank Pins Management
		 */
		bankPinManager(Ataratix);

		/**
		 * Account Manager
		 */
		accountManager(Ataratix);
	...
	public static void screenOptions(TextDrawingArea[] ataratix) {
		RSInterface tab = addInterface(28200);
		addSprite(28201, 472);
		addText(28202, "Screen Options", ataratix, 2, 0xff9933, true, true);
		...
		addText(28209, "Transparent side panel", ataratix, 1, 0xff9933, false, true);
		addText(28210, "Make each side panel transparent", ataratix, 0, 0xff9933, false, true);
		addText(28211, "Transparent chatbox", ataratix, 1, 0xff9933, false, true);
		addText(28212, "Make chatbox transparent", ataratix, 0, 0xff9933, false, true);
		addText(28213, "Side-stones arrangement", ataratix, 1, 0xff9933, false, true);
		addText(28214, "Change the side-stones arrangement", ataratix, 0, 0xff9933, false, true);
		addText(28215, "Settings are not applicable in fixed mode!", ataratix, 0, 0xff9933, true, true);
	...
	public static void accountManager(TextDrawingArea[] daniel) {
		...
		addText(56006, "Please answer the following prompts to ensure a safe account.", daniel, 0, 0xff9933, true,
				true);
		addText(56007, "Having a safe account is crucial in the world of Ataratix.", daniel, 0, 0xff9933, true, true);
	...
	public static void reportAbuse(TextDrawingArea[] daniel) {
		...
		addText(41756, "This form is for reporting players who are breaking our rules.", daniel, 1, 0xff9933, true,
				true);
		addText(41757, "Using it sends a snapshot of the last 60 seconds of activity to us.", daniel, 1, 0xff9933, true,
				true);
		...
		addText(41761, "Please select the rule of which the offending player has broken.", daniel, 1, 0xff9933, true,
				true);

		String[] rules = { "Offensive language", "Item scamming", "Password scamming", "Bug abuse",
				"Ataratix staff impersonation", "Account sharing/trading", "Macroing", "Multiple logging in",
				"Advertising", "Real world trading", "Misuse of customer support",
	...
	public static String[][] shopCategories = new String[][] { { "Purchasables", "413" }, { "Achievements", "414" },
			{ "Colors", "407" } };

	public static String[][][] shopContent = new String[][][] {
			/** Main Titles */
			{ { "Sir", "15" }, { "Miss", "15" }, { "Lord", "20" }, { "Duderino", "25" }, { "Copycat", "50" },
					{ "King", "50" }, { "Queen", "50" }, { "Fam", "60" }, { "Brother", "65" }, { "Sister", "65" },
					{ "Overlord", "75" }, { "The", "100" }, { "RichieRich", "100" }, { "Emperor", "125" },
					{ "Immortal", "135" }, { "The Great", "140" }, { "Champion", "150" }, { "Swagtastic", "175" },
					{ "Godly", "200" }, { "Respected", "205" }, { "The One", "210" }, { "Holy", "220" },
					{ "Skilled", "230" },

			},

			/** Achievement Titles */
			{ { "Skeletal", "250 skeletal" }, { "Blood", "1500 blood" }, { "Multi-task", "100 tasks" },
					{ "Pet", "10 pets" }, { "Tztok", "50 firecape" }, { "The Game", "Win WG 10" },
			...
			/** Colors */
			{ { "<col=C22323>Red", "@whi@5,000.000" }, { "<col=0FA80F>Green", "@whi@5,000.000" },
					{ "<col=2AA4C9>Blue", "@whi@5,000.000" }, { "<col=C9BC28>Yellow", "@whi@5,000.000" },
					{ "<col=F58D16>Orange", "@whi@5,000.000" }, { "<col=C931E8>Purple", "@whi@5,000.000" },
					{ "<col=F52CD7>Pink", "@whi@5,000.000" }, { "<col=FFFFFF>White", "@whi@5,000.000" }, } };

	public static void fireColor(TextDrawingArea[] ataratix) {
		RSInterface tab = addInterface(49750);
		addSprite(49751, 400);
		addHoverButton(49752, 21, 21, 21, "Close", 250, 49753, 3);
		addHoveredButton(49753, 22, 21, 21, 49754);
		addText(49755, "Fire Color Changer", 0xff9933, true, true, -1, ataratix, 2);
		addText(49756, "By paying 10 credits you can change all fire colors.", 0xff9933, true, true, -1, ataratix, 0);
		addText(49757, "You will earn double cooking & firemaking exp for 30mins.", 0xff9933, true, true, -1, ataratix,
				0);
		addText(49758, "Current Color: Orange", 0xff9933, true, true, -1, ataratix, 0);
		addText(49759, "Changed by: Daniel", 0xff9933, true, true, -1, ataratix, 0);
		addText(49760, "Daniel's Clan: Ataratix", 0xff9933, true, true, -1, ataratix, 0);
		addText(49761, "Change availability: 45minutes", 0xff9933, true, true, -1, ataratix, 0);
	...
	public static void starter(TextDrawingArea[] daniel) {
		...
		addSprite(51751, 431);
		addText(51752, "Ataratix Account Setup", 0xff9933, true, true, 52, daniel, 2);
	...
	public static void spawnTab(TextDrawingArea[] daniel) {
		...
		addSprite(61251, 82);
		addSprite(61252, 38);
		addText(61253, "AtaratixPK Spawn Tab", daniel, 0, 0xF7AA25, true, true);
	...
	public static void loyaltyShop(TextDrawingArea[] tda) {
		...
		addText(id + 8, "Welcome to the Ataratix title shop.", tda, 0, 0xe6be78, false, true);
		...
		for (int index = 0, frame = 0, configOffset = 0; index < shopCategories.length * 3; index += 3) {
			...
			loyaltySubShop(id + frame + 13, id, configOffset, tda, shopContent[index / 3],
	...
	public static void loyaltySubShop(int id, int parent, int configOffset, TextDrawingArea[] tda, String[][] titles,
			int currency) {
		RSInterface shop = addTabInterface(id);
		...
		for (int index = 0; index < titles.length * 7; index += 7) {
			...
			addHoverConfigButton(id + frame + 2, id + frame + 3, 374, 375, 56, 11, "Buy", new int[] { 0 },
					new int[] { 0 }, new int[][] { { 1040 + index / 7 + configOffset } });
	...
	public static void tracker(TextDrawingArea[] ataratix) {
		RSInterface tab = addInterface(54100);
		addSprite(54101, 371);
		addHoverButton(54102, 17, 21, 21, "Close", 250, 54103, 3);
		addHoveredButton(54103, 18, 21, 21, 54104);
		addText(54105, "Tracker", 0xff9933, true, true, -1, ataratix, 2);
		addText(54106, "Show's a list of tracked statistics.", 0xff9933, true, true, -1, ataratix, 0);
		tab.totalChildren(6);
		...
		int y = 0;
		for (int i = 0; i < 50; i++) {
			addHoverText(54111 + i, "", "", ataratix, 0, 0xcc8000, true, true, 300);
	 ...
	 * @param ataratix
	 */
	public static void bankSettings(TextDrawingArea[] ataratix) {
		RSInterface tab = addInterface(32500);
		addSprite(32501, 368);
		addText(32502, "Ataratix Bank Settings", 0xff9933, true, true, -1, ataratix, 2);
		...
		addText(32509, "First item in tab", 0xff9933, true, true, -1, ataratix, 1);
		addText(32510, "Digit (1, 2, 3)", 0xff9933, true, true, -1, ataratix, 1);
		addText(32511, "Roman numeral (I, II, III)", 0xff9933, true, true, -1, ataratix, 1);
		addHoverText(32512, "Back to bank", "View", ataratix, 1, 0xcc8000, true, true, 100, 0xFFFFFF);
		tab.totalChildren(11);
	...
	public static void staffTab(TextDrawingArea[] daniel) {
		...
		String[] titles = { "@mbl@Check bank user", "@mbl@Kick user", "@mbl@Mute user", "@mbl@Unmute user",
				"@mbl@Ban user", "@mbl@Unban user", "@mbl@Jail user", "@mbl@Unjail user", "@mbl@Move home user",
				"@mye@Copy user", "@mye@Freeze user", "@mbl@Get info user", "@mye@Demote user", "@mye@Give mod user",
				"@mre@Kill user", "@mbl@Tele to user", "@mbl@Tele to me user", "@mre@Boo user", "@mre@Random NPC user",
				"@mye@Refresh" };
	...
	public static void myProfile(TextDrawingArea[] daniel) {
		...
		for (int i = 0; i < 20; i++) {
			...
			addTooltipBox(51632 + i, Skills.SKILL_NAMES[i].substring(0, 1).toUpperCase()
					+ Skills.SKILL_NAMES[i].substring(1) + " level: 1/1\\nPrestige level: 1");
	...
	public static void playerProfiler(TextDrawingArea[] daniel) {
		...
		for (int i = 0; i < 20; i++) {
			...
			addTooltipBox(51832 + i, Skills.SKILL_NAMES[i].substring(0, 1).toUpperCase()
					+ Skills.SKILL_NAMES[i].substring(1) + " level: 1/1\\nPrestige level: 1");
	...
	public static void friendsTab(TextDrawingArea[] tda) {
		...
		addText(5070, "   Ataratix", tda, 0, 0xff9933, false, true);
	...
	public static void ignoreTab(TextDrawingArea[] tda) {
		...
		addText(5720, "   Ataratix", tda, 0, 0xff9933, false, true);
	...
	public static void itemDetails(TextDrawingArea[] ataratix) {
		RSInterface tab = addInterface(59750);
		addSprite(59751, 456);
		addText(59752, "Item Details:", 0xff9933, true, true, -1, ataratix, 2);
		addText(59753, "</col>Item: @gre@Armadyl Godsword", 0xff9933, true, true, -1, ataratix, 0);
		addText(59754, "</col>General Price: @gre@85M", 0xff9933, true, true, -1, ataratix, 0);
		addText(59755, "</col>Tradeable: @gre@True", 0xff9933, true, true, -1, ataratix, 0);
		addText(59756, "</col>Noted: @gre@False", 0xff9933, true, true, -1, ataratix, 0);
		itemDisplay(59757, 30, 10, 5, 5, "Complain");
		addHoverText(59758, "-> Back <-", "Go back to drop table", ataratix, 0, 0xff9933, true, true, 300);
		tab.totalChildren(8);
	 ...
	 * @param ataratix
	 */
	public static void dropTable(TextDrawingArea[] ataratix) {
		RSInterface tab = addInterface(59800);
		addSprite(59801, 16);
		addHoverButton(59802, 454, 17, 17, "Close", 250, 59803, 3);
		addHoveredButton(59803, 455, 17, 17, 59804);
		addText(59805, "Monster Drop Guide", 0xff9933, true, true, -1, ataratix, 2);
		addText(59806, "Name:", 0xff9933, true, false, -1, ataratix, 0);
		addText(59807, "Level:", 0xff9933, true, false, -1, ataratix, 0);
		addText(59818, "", 0xff9933, true, false, -1, ataratix, 0);
		String[] table = { "Always", "Common", "Uncommon", "Rare", "Very Rare" };
		for (int i = 0; i < table.length; i++) {
			addText(59808 + i, table[i], 0x000000, true, false, -1, ataratix, 0);
		}
		...
		int y = 0;
		for (int i = 0; i < 50; i++) {
			addHoverText(59901 + i, "", "", ataratix, 0, 0xCF4F0A, false, true, 300);
	...
	public static void mysteryBox(TextDrawingArea[] daniel) {
		...
		addText(17008, "Mystery Box is a gambling minigame where you can bet 1 credit.", daniel, 0, 0xF7AA25, true,
				true);
		addText(17009, "Rewards can vary from items worth @gre@1,000</col> - @gre@100,000,000</col> coins!", daniel, 0,
				0xF7AA25, true, true);
		addText(17010, "Good luck, may the odds be ever in your favor.", daniel, 0, 0xF7AA25, true, true);
		addHoverText(17011, "Purchase more credits", "Purchase Ataratix credits", daniel, 0, 0xF7AA25, false, true,
				168);
	...
	public static void creditsTab(TextDrawingArea[] daniel) {
		...
		addSprite(52501, 38);
		addText(52502, "Ataratix Credits", 0xff9933, true, true, -1, daniel, 2);
		addSprite(52503, 55);
		addText(52504, "Current credits:", 0xff9933, true, true, -1, daniel, 0);
		addHoverText(52505, "Purchase more credits", "Purchase Ataratix credits", daniel, 0, 0xF7AA25, true, true, 168);
		addSprite(52506, 56);
		tab.totalChildren(9);
	 ...
	 * @param ataratix
	 */
	private static void shop(TextDrawingArea[] ataratix) {
		...
		addText(19679, "", 0xff981f, false, true, 52, ataratix, 1);
		addText(19680, "", 0xbf751d, false, true, 52, ataratix, 1);
		addButton(19681, 2, "Interfaces/Shop/SHOP", 0, 0, "", 1);
		addSprite(19687, 1, "Interfaces/Shop/ITEMBG");
		for (int i = 0; i < 36; i++) {
			addText(28000 + i, "-1,0", 0xffff00, false, false, 52, ataratix, 0);
		}
		...
		addText(19684, "Main Stock", 0xbf751d, false, true, 52, ataratix, 1);
		addText(19685, "Store Info", 0xff981f, false, true, 52, ataratix, 1);
	 ...
	 * @param ataratix
	 */
	public static void trainingTeleport(TextDrawingArea[] ataratix) {
		...
		addText(61023, "@or2@Teleportation Menu (@red@Training@or2@)", 0xff9933, true, true, -1, ataratix, 2);
		addText(61024, "@gre@Training", 0xff9933, true, true, -1, ataratix, 1);
		addText(61025, "Skilling", 0xff9933, true, true, -1, ataratix, 1);
		addText(61026, "Player Vs Player", 0xff9933, true, true, -1, ataratix, 1);
		addText(61027, "Player Vs Monster", 0xff9933, true, true, -1, ataratix, 1);
		addText(61028, "Minigame", 0xff9933, true, true, -1, ataratix, 1);
		addText(61029, "Other", 0xff9933, true, true, -1, ataratix, 1);
		addText(61030, "Teleport Information:", 0xff9933, true, true, -1, ataratix, 2);
		addText(61031, "Selected: @red@None", 0xff9933, false, true, -1, ataratix, 0);
		addText(61032, "Cost: @red@Free", 0xff9933, false, true, -1, ataratix, 0);
		addText(61033, "Requirement: @red@None", 0xff9933, false, true, -1, ataratix, 0);
		addText(61034, "Other: @red@None", 0xff9933, false, true, -1, ataratix, 0);
		addHoverButton(61035, 61, 123, 30, "Confirm Teleport", 0, 61036, 1);
		addHoveredButton(61036, 62, 123, 30, 61037);
		addText(61038, "Go!", 0xff9933, true, true, -1, ataratix, 3);
		tab.totalChildren(31);
		...
		int y = 0;
		for (int i = 0; i < 40; i++) {
			addHoverText(61051 + i, "", "Select", ataratix, 1, 0xff9633, true, true, 300);
	 ...
	 * @param ataratix
	 */
	public static void skillingTeleport(TextDrawingArea[] ataratix) {
		...
		addText(62023, "@or2@Teleportation Menu (@red@Skilling@or2@)", 0xff9933, true, true, -1, ataratix, 2);
		addText(62024, "Training", 0xff9933, true, true, -1, ataratix, 1);
		addText(62025, "@gre@Skilling", 0xff9933, true, true, -1, ataratix, 1);
		addText(62026, "Player Vs Player", 0xff9933, true, true, -1, ataratix, 1);
		addText(62027, "Player Vs Monster", 0xff9933, true, true, -1, ataratix, 1);
		addText(62028, "Minigame", 0xff9933, true, true, -1, ataratix, 1);
		addText(62029, "Other", 0xff9933, true, true, -1, ataratix, 1);
		addText(62030, "Teleport Information:", 0xff9933, true, true, -1, ataratix, 2);
		addText(62031, "Selected: @red@None", 0xff9933, false, true, -1, ataratix, 0);
		addText(62032, "Cost: @red@Free", 0xff9933, false, true, -1, ataratix, 0);
		addText(62033, "Requirement: @red@None", 0xff9933, false, true, -1, ataratix, 0);
		addText(62034, "Other: @red@None", 0xff9933, false, true, -1, ataratix, 0);
		addHoverButton(62035, 61, 123, 30, "Confirm Teleport", 0, 62036, 1);
		addHoveredButton(62036, 62, 123, 30, 62037);
		addText(62038, "Go!", 0xff9933, true, true, -1, ataratix, 3);
		tab.totalChildren(31);
		...
		int y = 0;
		for (int i = 0; i < 40; i++) {
			addHoverText(62051 + i, "", "Select", ataratix, 1, 0xff9633, true, true, 300);
	 ...
	 * @param ataratix
	 */
	public static void pvpTeleport(TextDrawingArea[] ataratix) {
		...
		addText(63023, "@or2@Teleportation Menu (@red@Player Vs Player@or2@)", 0xff9933, true, true, -1, ataratix, 2);
		addText(63024, "Training", 0xff9933, true, true, -1, ataratix, 1);
		addText(63025, "Skilling", 0xff9933, true, true, -1, ataratix, 1);
		addText(63026, "@gre@Player Vs Player", 0xff9933, true, true, -1, ataratix, 1);
		addText(63027, "Player Vs Monster", 0xff9933, true, true, -1, ataratix, 1);
		addText(63028, "Minigame", 0xff9933, true, true, -1, ataratix, 1);
		addText(63029, "Other", 0xff9933, true, true, -1, ataratix, 1);
		addText(63030, "Teleport Information:", 0xff9933, true, true, -1, ataratix, 2);
		addText(63031, "Selected: @red@None", 0xff9933, false, true, -1, ataratix, 0);
		addText(63032, "Cost: @red@Free", 0xff9933, false, true, -1, ataratix, 0);
		addText(63033, "Requirement: @red@None", 0xff9933, false, true, -1, ataratix, 0);
		addText(63034, "Other: @red@None", 0xff9933, false, true, -1, ataratix, 0);
		addHoverButton(63035, 61, 123, 30, "Confirm Teleport", 0, 63036, 1);
		addHoveredButton(63036, 62, 123, 30, 63037);
		addText(63038, "Go!", 0xff9933, true, true, -1, ataratix, 3);
		tab.totalChildren(31);
		...
		int y = 0;
		for (int i = 0; i < 40; i++) {
			addHoverText(63051 + i, "", "Select", ataratix, 1, 0xff9633, true, true, 300);
	 ...
	 * @param ataratix
	 */
	public static void bossTeleport(TextDrawingArea[] ataratix) {
		...
		addText(64023, "@or2@Teleportation Menu (@red@Player Vs Monster@or2@)", 0xff9933, true, true, -1, ataratix, 2);
		addText(64024, "Training", 0xff9933, true, true, -1, ataratix, 1);
		addText(64025, "Skilling", 0xff9933, true, true, -1, ataratix, 1);
		addText(64026, "Player Vs Player", 0xff9933, true, true, -1, ataratix, 1);
		addText(64027, "@gre@Player Vs Monster", 0xff9933, true, true, -1, ataratix, 1);
		addText(64028, "Minigame", 0xff9933, true, true, -1, ataratix, 1);
		addText(64029, "Other", 0xff9933, true, true, -1, ataratix, 1);
		addText(64030, "Teleport Information:", 0xff9933, true, true, -1, ataratix, 2);
		addText(64031, "Selected: @red@None", 0xff9933, false, true, -1, ataratix, 0);
		addText(64039, "Level: @red@0", 0xff9933, false, true, -1, ataratix, 0);
		addText(64032, "Cost: @red@Free", 0xff9933, false, true, -1, ataratix, 0);
		addText(64033, "Requirement: @red@None", 0xff9933, false, true, -1, ataratix, 0);
		addText(64034, "Other: @red@None", 0xff9933, false, true, -1, ataratix, 0);
		addHoverButton(64035, 61, 123, 30, "Confirm Teleport", 0, 64036, 1);
		addHoveredButton(64036, 62, 123, 30, 64037);
		addText(64038, "Go!", 0xff9933, true, true, -1, ataratix, 3);
		...
		int y = 0;
		for (int i = 0; i < 40; i++) {
			addHoverText(64051 + i, "", "Select", ataratix, 1, 0xff9633, true, true, 300);
	 ...
	 * @param ataratix
	 */
	public static void minigameTeleport(TextDrawingArea[] ataratix) {
		...
		addText(65023, "@or2@Teleportation Menu (@red@Minigame@or2@)", 0xff9933, true, true, -1, ataratix, 2);
		addText(65024, "Training", 0xff9933, true, true, -1, ataratix, 1);
		addText(65025, "Skilling", 0xff9933, true, true, -1, ataratix, 1);
		addText(65026, "Player Vs Player", 0xff9933, true, true, -1, ataratix, 1);
		addText(65027, "Player Vs Monster", 0xff9933, true, true, -1, ataratix, 1);
		addText(65028, "@gre@Minigame", 0xff9933, true, true, -1, ataratix, 1);
		addText(65029, "Other", 0xff9933, true, true, -1, ataratix, 1);
		addText(65030, "Teleport Information:", 0xff9933, true, true, -1, ataratix, 2);
		addText(65031, "Selected: @red@None", 0xff9933, false, true, -1, ataratix, 0);
		addText(65032, "Cost: @red@Free", 0xff9933, false, true, -1, ataratix, 0);
		addText(65033, "Requirement: @red@None", 0xff9933, false, true, -1, ataratix, 0);
		addText(65034, "Other: @red@None", 0xff9933, false, true, -1, ataratix, 0);
		addHoverButton(65035, 61, 123, 30, "Confirm Teleport", 0, 65036, 1);
		addHoveredButton(65036, 62, 123, 30, 65037);
		addText(65038, "Go!", 0xff9933, true, true, -1, ataratix, 3);
		tab.totalChildren(31);
		...
		int y = 0;
		for (int i = 0; i < 40; i++) {
			addHoverText(65051 + i, "", "Select", ataratix, 1, 0xff9633, true, true, 300);
	 ...
	 * @param ataratix
	 */
	public static void otherTeleport(TextDrawingArea[] ataratix) {
		...
		addText(61523, "@or2@Teleportation Menu (@red@Other@or2@)", 0xff9933, true, true, -1, ataratix, 2);
		addText(61524, "Training", 0xff9933, true, true, -1, ataratix, 1);
		addText(61525, "Skilling", 0xff9933, true, true, -1, ataratix, 1);
		addText(61526, "Player Vs Player", 0xff9933, true, true, -1, ataratix, 1);
		addText(61527, "Player Vs Monster", 0xff9933, true, true, -1, ataratix, 1);
		addText(61528, "Minigame", 0xff9933, true, true, -1, ataratix, 1);
		addText(61529, "@gre@Other", 0xff9933, true, true, -1, ataratix, 1);
		addText(61530, "Teleport Information:", 0xff9933, true, true, -1, ataratix, 2);
		addText(61531, "Selected: @red@None", 0xff9933, false, true, -1, ataratix, 0);
		addText(61532, "Cost: @red@Free", 0xff9933, false, true, -1, ataratix, 0);
		addText(61533, "Requirement: @red@None", 0xff9933, false, true, -1, ataratix, 0);
		addText(61534, "Other: @red@None", 0xff9933, false, true, -1, ataratix, 0);
		addHoverButton(61535, 61, 123, 30, "Confirm Teleport", 0, 61536, 1);
		addHoveredButton(61536, 62, 123, 30, 61537);
		addText(61538, "Go!", 0xff9933, true, true, -1, ataratix, 3);
		tab.totalChildren(31);
		...
		int y = 0;
		for (int i = 0; i < 40; i++) {
			addHoverText(61551 + i, "", "Select", ataratix, 1, 0xff9633, true, true, 300);
	...
	public static void optionTab(TextDrawingArea[] ataratix) {
		...
		addText(36016, "", ataratix, 1, 0xff9933, true, true);
		addText(36003, "Options Tab", ataratix, 1, 0xff9933, true, true);
		addText(36013, "Fixed", ataratix, 0, 0xff9933, true, true);
		addText(36014, "Resizable", ataratix, 0, 0xff9933, true, true);
		addText(36015, "Fullscreen", ataratix, 0, 0xff9933, true, true);
		addHoverText(36025, "Screen Options", "Screen Options", ataratix, 0, 0xff981f, true, true, 60);
		 ...
		 * 
		 * tab.child(35, 36033, 38, 143); tab.child(36, 36034, 70, 143); tab.child(37,
		 * 36035, 102, 143); tab.child(38, 36036, 134, 143); tab.child(39, 36037, 156,
		 * 143);
		 */
	...
	public static void bank(TextDrawingArea[] wid) {
		...
		addContainer(5382, 109, 8, 44, new String[] { "Withdraw-1", "Withdraw-5", "Withdraw-10", "Withdraw-All",
				"Withdraw-X", null, "Withdraw-All but one" });
		...
		addButton(id + 7, method207(0, aClass44, "miscgraphics3"), method207(0, aClass44, "miscgraphics3"), "Show menu",
				25, 25);
		addSprite(id + 8, 118);
		addSprite(id + 9, 116);
		addSprite(id + 10, 117);
		...
		for (int tab = 0; tab < 40; tab += 4) {
			addButton(id + 13 + tab, Client.cacheSprite[111], Client.cacheSprite[111],
					"Collapse " + (tab == 0 ? "@or2@all tabs" : "tab @or2@" + (tab / 4)), 39, 40);
			int[] array = { 21, (tab / 4), 0 };
			if (tab / 4 == 0) {
				array = new int[] { 5, 1000, 0 };
			}
			addHoverConfigButton(id + 14 + tab, id + 15 + tab, 109, 111, 39, 40, tab == 0 ? "View all" : "New tab",
					new int[] { 1, tab / 4 == 0 ? 1 : 3 }, new int[] { (tab / 4), 0 },
	 ...
	 * @param ataratix
	 */
	public static void quickPrayers(TextDrawingArea[] ataratix) {
		int frame = 0;
	 ...
	 * @param ataratix
	 */
	public static void quickCurses(TextDrawingArea[] ataratix) {
		RSInterface tab = addTabInterface(17234);
		addTransparentSprite(17229, 444);
		addSprite(17201, 445);
		addText(17230, "Select your quick prayers:", ataratix, 0, 0xFF981F, false, true);
		for (int i = 17202, j = 630; i <= 17228 || j <= 656; i++, j++) {
			addConfigButton(i, 17200, 79, 78, 14, 15, "Select prayer", 0, 1, j);
			// addConfigButton(j, 17200, 2, 1, "QuickPrayer/Sprite", 14, 15, "Select", 0, 1,
			// k);
	 ...
	 * @param ataratix
	 */
	public static void equipmentScreen(TextDrawingArea[] ataratix) {
		...
		addText(15111, "", ataratix, 2, 0xe4a146, false, true);
		addText(15112, "Attack bonus", ataratix, 2, 0xFF981F, false, true);
		addText(15113, "Defence bonus", ataratix, 2, 0xFF981F, false, true);
		addText(15114, "Other bonuses", ataratix, 2, 0xFF981F, false, true);
		addText(15115, "Equipment Bonuses", ataratix, 2, 0xFF981F, false, true);
		addText(15116, "", ataratix, 0, 0xFF981F, true, true);
		addText(15117, "", ataratix, 0, 0xFF981F, true, true);
		addText(15118, "", ataratix, 0, 0xFF981F, true, true);
		for (int i = 1675; i <= 1684; i++) {
			textSize(i, ataratix, 1);
		}
		textSize(1686, ataratix, 1);
		textSize(1687, ataratix, 1);
		addChar(15125, 560);
	 ...
	 * @param ataratix
	 */
	public static void equipmentTab(TextDrawingArea[] ataratix) {
	 ...
	 * @param ataratix
	 */
	public static void clanChatTab(TextDrawingArea[] ataratix) {
		...
		addText(18135, "Join/Leave", ataratix, 0, 0xff9b00, true, true);
		addText(18136, "Clan Setup", ataratix, 0, 0xff9b00, true, true);
		addSprite(18137, 42);
		addText(18138, "Clan Chat", ataratix, 2, 0xff9b00, true, true);
		addText(18139, "Talking in: Not in chat", ataratix, 0, 0xff9b00, false, true);
		addText(18140, "Owner: None", ataratix, 0, 0xff9b00, false, true);

		addText(18252, "(0/100)", ataratix, 0, 0xff9b00, false, true);
		tab.totalChildren(14);
		...
		for (int i = 18144; i <= 18244; i++) {
			addText(i, "", ataratix, 0, 0xffffff, false, true);
		}
	 ...
	 * @param ataratix
	 */
	public static void clanChatSetup(TextDrawingArea[] ataratix) {
		...
		/* Clan Setup title */
		addText(43703, "Clan Setup", ataratix, 2, 0xFF981F, true, true);
		...
		for (int index = 0, id = 43704, y = 50; index < titles.length; index++, id += 3, y += 40) {
			...
			addText(id + 1, titles[index], ataratix, 0, 0xFF981F, true, true);
			addText(id + 2, defaults[index], ataratix, 1, 0xFFFFFF, true, true);
		...
		int id = 43720;
		int y = 74;
		addText(id, "Ranked Members", ataratix, 2, 0xFF981F, false, true);
		rsi.child(count++, id++, 202, y);
		addText(id, "Banned Members", ataratix, 2, 0xFF981F, false, true);
		...
		for (int index = id; index < id + lines; index++) {
			addText(index, "", ataratix, 1, 0xffffff, false, true);
		...
		/* Table info text */
		y = 47;
		addText(id, "You can manage both ranked and banned members here.", ataratix, 0, 0xFF981F, true, true);
		rsi.child(count++, id++, 337, y);
		addText(id, "Right click on a name to edit the member.", ataratix, 0, 0xFF981F, true, true);
	 ...
	 * @param ataratix
	 */
	public static void questTab(TextDrawingArea[] ataratix) {
		RSInterface tab = addTabInterface(29400);
		addSprite(29401, 82);
		addSprite(29402, 38);
		addText(29403, "Ataratix", ataratix, 2, 0xF7AA25, true, true);
		addText(29407, "Www.Ataratix.Com", ataratix, 2, 0xF7AA25, true, true);
		...
		addHoverText(29413, "", "", ataratix, 0, 0x47B320, false, true, 50);
		tab.scrollMax = 0;
		tab.totalChildren(11);
		...
		for (int i = 0; i < amountOfLines; i++) {
			addHoverText(29501 + i, "", "", ataratix, 0, 0x47B320, false, true, 168);
