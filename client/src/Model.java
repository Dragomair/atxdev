public class Model extends Animable {
	...
	public void interpolateFrames(int frame, int nextFrame, int cycle, int length) {
		...
		if (nextAnim == null) {
			for (int index = 0; index < currAnim.anInt638; index++) {
				...
				method472(skinList.anIntArray342[anim], skinList.anIntArrayArray343[anim],
						currAnim.anIntArray640[index], currAnim.anIntArray641[index], currAnim.anIntArray642[index]);
			}
		} else {
			int currFrameId = 0;
			int nextFrameId = 0;
	...
	private final void method484(int i) {
		...
		if (i1 == 0) {
			Rasterizer.method374(anIntArray1666[j], anIntArray1666[k], anIntArray1666[l], anIntArray1665[j],
					anIntArray1665[k], anIntArray1665[l], anIntArray1634[i], anIntArray1635[i], anIntArray1636[i],
					anIntArray1670[j], anIntArray1670[k], anIntArray1670[l]);
			return;
		}
		if (i1 == 1) {
			Rasterizer.method376(anIntArray1666[j], anIntArray1666[k], anIntArray1666[l], anIntArray1665[j],
					anIntArray1665[k], anIntArray1665[l], modelIntArray3[anIntArray1634[i]], anIntArray1670[j],
	...
	private final void method485(int i) {
		...
		if ((j3 - j4) * (k7 - j7) - (i7 - j7) * (j5 - j4) > 0) {
			...
			if (l == 3) {
				...
				if (l7 == 0)
					Rasterizer.method374(i7, j7, k7, j3, j4, j5, anIntArray1680[0], anIntArray1680[1],
					...
					Rasterizer.method378(i7, j7, k7, j3, j4, j5, anIntArray1680[0], anIntArray1680[1],
							...
							anIntArray1670[k10], anIntArray1670[k11], anIntArray1640[i], anIntArray1670[i1],
							anIntArray1670[j1], anIntArray1670[k1]);
				} else if (l7 == 3) {
					int k8 = anIntArray1637[i] >> 2;
					int l9 = anIntArray1643[k8];
					int l10 = anIntArray1644[k8];
					int l11 = anIntArray1645[k8];
					Rasterizer.method378(i7, j7, k7, j3, j4, j5, anIntArray1634[i], anIntArray1634[i],
							...
							anIntArray1670[l10], anIntArray1670[l11], anIntArray1640[i], anIntArray1670[i1],
							anIntArray1670[j1], anIntArray1670[k1]);
				}
			}
			if (l == 4) {
				...
				if (i8 == 0) {
					...
					Rasterizer.method374(i7, k7, anIntArray1679[3], j3, j5, anIntArray1678[3], anIntArray1680[0],
							anIntArray1680[2], anIntArray1680[3], anIntArray1670[i1], anIntArray1670[j1],
							anIntArray1670[k1]);
					return;
				}
				if (i8 == 1) {
					...
					Rasterizer.method376(i7, k7, anIntArray1679[3], j3, j5, anIntArray1678[3], l8, anIntArray1670[i1],
							anIntArray1670[j1], anIntArray1670[k1]);
					return;
				}
				if (i8 == 2) {
					...
					Rasterizer.method378(i7, j7, k7, j3, j4, j5, anIntArray1680[0], anIntArray1680[1],
							...
							anIntArray1670[i11], anIntArray1670[i12], anIntArray1640[i], anIntArray1670[i1],
							anIntArray1670[j1], anIntArray1670[k1]);
					Rasterizer.method378(i7, k7, anIntArray1679[3], j3, j5, anIntArray1678[3], anIntArray1680[0],
							...
							anIntArray1670[i1], anIntArray1670[j1], anIntArray1670[k1]);
					return;
				}
				if (i8 == 3) {
					...
					Rasterizer.method378(i7, j7, k7, j3, j4, j5, anIntArray1634[i], anIntArray1634[i],
							...
							anIntArray1670[j11], anIntArray1670[j12], anIntArray1640[i], anIntArray1670[i1],
							anIntArray1670[j1], anIntArray1670[k1]);
