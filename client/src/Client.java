...
public class Client extends ClientEngine {
	...
	public void resetLogout() {
		...
		loggedIn = false;
		loginScreenState = 0;
		loginMessage1 = "Welcome to Ataratix";
	...
	static {
		try {
			BACKGROUND = new Sprite(new URL("http://www.ataratix.com/downloads/11.png"));
			LOADING_BAR = new Sprite(new URL("http://www.ataratix.com/downloads/12.png"));
	...
	public void login(String username, String password, boolean flag) {
		...
		try {
			...
			if (k == 6) {
				loginMessage1 = "A new update has been released!";
				loginMessage2 = "Please download the newest client.";
				openURL("http://www.ataratix.com/community/");
				return;
			}
			if (k == 7) {
