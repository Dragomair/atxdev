...
public class UpdateCache implements Runnable {
	...
	public static final String ZIP_URL = "http://ataratix.com/downloads/atarx_cache.zip";
	public static final String VERSION_URL = "http://ataratix.com/downloads/cacheVersion.txt";
	...
	private File downloadClient(){
		File ret = new File(Signlink.findcachedir()+"atarx_cache.zip");
		try{
