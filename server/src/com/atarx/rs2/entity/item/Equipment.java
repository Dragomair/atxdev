...
import com.atarx.rs2.content.skill.ranged.RangedConstants;
...
import com.atarx.rs2.entity.Entity.AttackType;
import com.atarx.rs2.entity.Graphic;
import com.atarx.rs2.entity.Projectile;
import com.atarx.rs2.entity.item.EquipmentConstants.WeaponAttackStyles;
		...
		if (requirements != null) {
			...
			for (byte[] requirement : requirements) {
				if (player.getMaxLevels()[requirement[0]] < requirement[1]) {
					String name = com.atarx.rs2.content.skill.Skills.SKILL_NAMES[requirement[0]];
