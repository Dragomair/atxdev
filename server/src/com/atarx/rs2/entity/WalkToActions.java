...
import com.atarx.core.cache.map.Doors;
import com.atarx.core.cache.map.DoubleDoor;
import com.atarx.core.cache.map.ObjectDef;
import com.atarx.core.cache.map.RSObject;
import com.atarx.core.cache.map.Region;
import com.atarx.core.definitions.ItemDefinition;
import com.atarx.core.task.Task;
import com.atarx.core.task.TaskQueue;
import com.atarx.core.task.impl.FollowToEntityTask;
import com.atarx.core.task.impl.HarvestTask;
import com.atarx.core.task.impl.HopDitchTask;
import com.atarx.core.task.impl.ObeliskTick;
import com.atarx.core.task.impl.PullLeverTask;
import com.atarx.core.task.impl.ShearingTask;
import com.atarx.core.task.impl.TeleOtherTask;
import com.atarx.core.task.impl.WalkThroughDoorTask;
import com.atarx.core.task.impl.WalkThroughDoubleDoorTask;
import com.atarx.core.task.impl.WalkToTask;
import com.atarx.core.util.GameDefinitionLoader;
import com.atarx.core.util.Utility;
import com.atarx.rs2.content.CrystalChest;
import com.atarx.rs2.content.DropTable;
import com.atarx.rs2.content.FountainOfRune;
import com.atarx.rs2.content.Prestige;
import com.atarx.rs2.content.achievements.AchievementHandler;
import com.atarx.rs2.content.achievements.AchievementList;
import com.atarx.rs2.content.dialogue.DialogueManager;
import com.atarx.rs2.content.dialogue.Emotion;
import com.atarx.rs2.content.dialogue.OneLineDialogue;
import com.atarx.rs2.content.dialogue.OptionDialogue;
import com.atarx.rs2.content.dialogue.impl.AchievementDialogue;
import com.atarx.rs2.content.dialogue.impl.AdamDialogue;
import com.atarx.rs2.content.dialogue.impl.BigMoDialogue;
import com.atarx.rs2.content.dialogue.impl.DecantingDialogue;
import com.atarx.rs2.content.dialogue.impl.DunceDialogue;
import com.atarx.rs2.content.dialogue.impl.EmblemDialogue;
import com.atarx.rs2.content.dialogue.impl.FiremakingDialogue;
import com.atarx.rs2.content.dialogue.impl.GamblerDialogue;
import com.atarx.rs2.content.dialogue.impl.GenieResetDialogue;
import com.atarx.rs2.content.dialogue.impl.HariDialogue;
import com.atarx.rs2.content.dialogue.impl.KamfreeDialogue;
import com.atarx.rs2.content.dialogue.impl.KolodionDialogue;
import com.atarx.rs2.content.dialogue.impl.MakeoverMage;
import com.atarx.rs2.content.dialogue.impl.MembershipDialogue;
import com.atarx.rs2.content.dialogue.impl.NeiveDialogue;
import com.atarx.rs2.content.dialogue.impl.OttoGodblessed;
import com.atarx.rs2.content.dialogue.impl.OziachDialogue;
import com.atarx.rs2.content.dialogue.impl.PilesDialogue;
import com.atarx.rs2.content.dialogue.impl.PrestigeDialogue;
import com.atarx.rs2.content.dialogue.impl.RunecraftingTeleport;
import com.atarx.rs2.content.dialogue.impl.SailorDialogue;
import com.atarx.rs2.content.dialogue.impl.SecurityDialogue;
import com.atarx.rs2.content.dialogue.impl.ShopExchangeDialogue;
import com.atarx.rs2.content.dialogue.impl.ShopExchangeDialogue2;
import com.atarx.rs2.content.dialogue.impl.StaffTitleDialogue;
import com.atarx.rs2.content.dialogue.impl.TzhaarMejKahDialogue;
import com.atarx.rs2.content.dialogue.impl.VannakaDialogue;
import com.atarx.rs2.content.dialogue.impl.WeaponGameDialogue;
import com.atarx.rs2.content.dialogue.impl.teleport.SpiritTree;
import com.atarx.rs2.content.dialogue.impl.teleport.WildernessLever;
import com.atarx.rs2.content.dwarfcannon.DwarfMultiCannon;
import com.atarx.rs2.content.membership.MysteryBoxMinigame;
import com.atarx.rs2.content.minigames.barrows.Barrows;
import com.atarx.rs2.content.minigames.clanwars.ClanWarsFFA;
import com.atarx.rs2.content.minigames.fightcave.TzharrGame;
import com.atarx.rs2.content.minigames.fightpits.FightPits;
import com.atarx.rs2.content.minigames.godwars.GodWars;
import com.atarx.rs2.content.minigames.pestcontrol.PestControl;
import com.atarx.rs2.content.minigames.plunder.PyramidPlunder;
import com.atarx.rs2.content.minigames.warriorsguild.ArmourAnimator;
import com.atarx.rs2.content.minigames.warriorsguild.CyclopsRoom;
import com.atarx.rs2.content.minigames.weapongame.WeaponGame;
import com.atarx.rs2.content.minigames.weapongame.WeaponGameStore;
import com.atarx.rs2.content.pets.BossPets;
import com.atarx.rs2.content.pets.BossPets.PetData;
import com.atarx.rs2.content.shopping.impl.BountyShop;
import com.atarx.rs2.content.shopping.impl.PestShop;
import com.atarx.rs2.content.skill.Skills;
import com.atarx.rs2.content.skill.agility.Agility;
import com.atarx.rs2.content.skill.agility.obstacle.interaction.WalkInteraction;
import com.atarx.rs2.content.skill.cooking.CookingTask;
import com.atarx.rs2.content.skill.crafting.CraftingType;
import com.atarx.rs2.content.skill.crafting.Flax;
import com.atarx.rs2.content.skill.crafting.HideTanning;
import com.atarx.rs2.content.skill.crafting.JewelryCreationTask;
import com.atarx.rs2.content.skill.crafting.Spinnable;
import com.atarx.rs2.content.skill.farming.Farming;
import com.atarx.rs2.content.skill.firemaking.FireColor;
import com.atarx.rs2.content.skill.herblore.PotionDecanting;
import com.atarx.rs2.content.skill.hunter.Impling.ImplingRewards.Implings;
import com.atarx.rs2.content.skill.magic.MagicSkill;
import com.atarx.rs2.content.skill.magic.MagicSkill.SpellBookTypes;
import com.atarx.rs2.content.skill.mining.Mining;
import com.atarx.rs2.content.skill.prayer.BoneBurying;
import com.atarx.rs2.content.skill.runecrafting.AbyssObjects;
import com.atarx.rs2.content.skill.runecrafting.RunecraftingTask;
import com.atarx.rs2.content.skill.smithing.SmithingConstants;
import com.atarx.rs2.content.skill.thieving.HomeStalls;
import com.atarx.rs2.content.skill.thieving.ThievingNpcTask;
import com.atarx.rs2.content.skill.thieving.ThievingStallTask;
import com.atarx.rs2.content.skill.thieving.WallSafes;
import com.atarx.rs2.content.skill.woodcutting.WoodcuttingTask;
import com.atarx.rs2.content.wilderness.Lockpick;
import com.atarx.rs2.content.wilderness.TargetSystem;
import com.atarx.rs2.entity.item.Item;
import com.atarx.rs2.entity.item.ItemCheck;
...
import com.atarx.rs2.entity.player.PlayerConstants;
import com.atarx.rs2.entity.player.net.out.impl.SendChatBoxInterface;
import com.atarx.rs2.entity.player.net.out.impl.SendEnterString;
import com.atarx.rs2.entity.player.net.out.impl.SendInterface;
import com.atarx.rs2.entity.player.net.out.impl.SendItemOnInterface;
import com.atarx.rs2.entity.player.net.out.impl.SendMessage;
import com.atarx.rs2.entity.player.net.out.impl.SendRemoveInterfaces;
import com.atarx.rs2.entity.player.net.out.impl.SendSound;
import com.atarx.rs2.entity.player.net.out.impl.SendString;
import com.atarx.rs2.entity.player.net.out.impl.SendUpdateItemsAlt;
...
public class WalkToActions {
	 ...
	 */
	public final static String[] DEFAULT_DIALOGUES = { "When you feel sad, just sing Roar - by Katy Perry!", "Thank the ataratix gods for this beautiful day!", "Break free of your cage and be happy!", "Porn is the key to a happy marriage.", "I'm in the mood to groove it out!", "Don't let fear hold you down.", "Just let it out, let it out.", "Make your dreams a reality.", "Be your own creator.", "Daniel blesses your soul." };
	...
	public static void finishObjectClick(Player player, int id, int option, int x, int y) {
		...
		case 1:
			...
			if (id == 8720 || id == 26820 || id == 26813) {
				player.send(new SendString("http://www.ataratix.com/vote/", 12000));
