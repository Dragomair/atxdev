...
import com.atarx.rs2.content.gambling.Gambling;
import com.atarx.rs2.content.gambling.Lottery;
		...
		case "givepack":
			if (parser.hasNext(2)) {
				try {
					...
					World.sendGlobalMessage("</col>[ @dre@ataratix </col>] @dre@" + p.determineIcon(p) + " " + Utility.formatPlayerName(p.getUsername()) + "</col> has just reedemed a @dre@" + pack + "</col> credit voucher!");
