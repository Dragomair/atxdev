...
import com.atarx.rs2.content.interfaces.impl.ModCommandsInterface;
import com.atarx.rs2.content.io.PlayerSave;
import com.atarx.rs2.content.io.PlayerSave.PlayerContainer;
import com.atarx.rs2.content.io.PlayerSave.PlayerDetails;
...
import com.atarx.rs2.entity.player.net.out.impl.SendSystemBan;
...
public class ModeratorCommand implements Command {
	...
	public boolean handleCommand(Player player, CommandParser parser) throws Exception {
		...
		case "modcommands":
		case "modcommand":
			player.send(new SendString("ataratix Mod Command List", 8144));
