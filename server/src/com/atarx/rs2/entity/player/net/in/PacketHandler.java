...
import com.atarx.core.network.ReceivedPacket;
...
import com.atarx.rs2.entity.player.net.in.impl.BankAllButOne;
import com.atarx.rs2.entity.player.net.in.impl.BankModifiableX;
import com.atarx.rs2.entity.player.net.in.impl.ChangeAppearancePacket;
import com.atarx.rs2.entity.player.net.in.impl.ChangeRegionPacket;
import com.atarx.rs2.entity.player.net.in.impl.ChatInterfacePacket;
import com.atarx.rs2.entity.player.net.in.impl.ClickButtonPacket;
import com.atarx.rs2.entity.player.net.in.impl.CloseInterfacePacket;
import com.atarx.rs2.entity.player.net.in.impl.CommandPacket;
import com.atarx.rs2.entity.player.net.in.impl.FlashingSideIconPacket;
import com.atarx.rs2.entity.player.net.in.impl.InputFieldPacket;
import com.atarx.rs2.entity.player.net.in.impl.InterfaceAction;
import com.atarx.rs2.entity.player.net.in.impl.ItemPackets;
import com.atarx.rs2.entity.player.net.in.impl.MovementPacket;
import com.atarx.rs2.entity.player.net.in.impl.NPCPacket;
import com.atarx.rs2.entity.player.net.in.impl.ObjectPacket;
import com.atarx.rs2.entity.player.net.in.impl.PlayerOptionPacket;
import com.atarx.rs2.entity.player.net.in.impl.PrivateMessagingPacket;
import com.atarx.rs2.entity.player.net.in.impl.PublicChatPacket;
import com.atarx.rs2.entity.player.net.in.impl.ReceiveString;
import com.atarx.rs2.entity.player.net.in.impl.ResetCounter;
//import com.atarx.rs2.entity.player.net.in.impl.SpawnTab;
import com.atarx.rs2.entity.player.net.in.impl.StringInputPacket;
