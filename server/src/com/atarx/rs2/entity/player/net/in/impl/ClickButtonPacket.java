...
import com.atarx.rs2.content.EasterRing;
import com.atarx.rs2.content.Emotes;
import com.atarx.rs2.content.GenieLamp;
import com.atarx.rs2.content.GenieReset;
import com.atarx.rs2.content.LoyaltyShop;
import com.atarx.rs2.content.PlayersOnline;
import com.atarx.rs2.content.Prestige;
import com.atarx.rs2.content.SkillsChat;
import com.atarx.rs2.content.StarterKit;
import com.atarx.rs2.content.TeleportHandler;
import com.atarx.rs2.content.achievements.AchievementButtons;
import com.atarx.rs2.content.combat.formula.MagicFormulas;
import com.atarx.rs2.content.combat.formula.MeleeFormulas;
import com.atarx.rs2.content.combat.formula.RangeFormulas;
import com.atarx.rs2.content.combat.impl.PlayerDrops;
...
import com.atarx.rs2.content.interfaces.impl.AchievementTab;
import com.atarx.rs2.content.interfaces.impl.BossInterface;
import com.atarx.rs2.content.interfaces.impl.MinigameInterface;
import com.atarx.rs2.content.interfaces.impl.OtherInterface;
import com.atarx.rs2.content.interfaces.impl.PointsInterface;
import com.atarx.rs2.content.interfaces.impl.PvPInterface;
import com.atarx.rs2.content.interfaces.impl.QuestTab;
import com.atarx.rs2.content.interfaces.impl.SkillingInterface;
import com.atarx.rs2.content.interfaces.impl.TrainingInterface;
import com.atarx.rs2.content.membership.CreditHandler;
...
import com.atarx.rs2.content.profiles.PlayerProfiler;
import com.atarx.rs2.content.profiles.ProfileLeaderboard;
import com.atarx.rs2.content.skill.SkillGoal;
...
import com.atarx.rs2.content.skill.crafting.Crafting;
import com.atarx.rs2.content.skill.crafting.HideTanning;
import com.atarx.rs2.content.skill.firemaking.FireColor;
import com.atarx.rs2.content.skill.fletching.Fletching;
import com.atarx.rs2.content.skill.herblore.HerbloreFinishedPotionTask;
import com.atarx.rs2.content.skill.herblore.HerbloreUnfinishedPotionTask;
import com.atarx.rs2.content.skill.magic.Autocast;
import com.atarx.rs2.content.skill.magic.MagicSkill.TeleportTypes;
import com.atarx.rs2.content.skill.magic.spells.BoltEnchanting;
...
import com.atarx.rs2.content.skill.summoning.SummoningCreation;
import com.atarx.rs2.entity.Animation;
import com.atarx.rs2.entity.Graphic;
import com.atarx.rs2.entity.ReportHandler;
import com.atarx.rs2.entity.ReportHandler.ReportData;
...
import com.atarx.rs2.entity.player.net.out.impl.SendOpenTab;
...
public class ClickButtonPacket extends IncomingPacket {
	...
	public void handle(Player player, StreamBuffer.InBuffer in, int opcode, int length) {
		...
		case 66108:
			...
			break;
		case 66115:
			player.send(new SendString("http://www.ataratix.com/store/", 12000));
			break;
		...
		case 154052:
			...
			break;
		case 115070:
			/*player.send(new SendString("@dre@ataratix's Latest Updates (</col> " + GameSettings.LATEST_UPDATE.length + " @dre@)", 8144));
			for (int i = 0; i < 30; i++) {
		...
		default:
			...
			if (Fletching.SINGLETON.clickButton(player, buttonId))
				break;
			if (com.atarx.rs2.content.skill.craftingnew.Crafting.SINGLETON.clickButton(player, buttonId))
				break;
