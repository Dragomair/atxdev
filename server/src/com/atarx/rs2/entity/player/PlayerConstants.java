...
public final class PlayerConstants {
	 ...
	 */
	public static final String[] OWNER_USERNAME = { "Mikey", "Chris"};
	...
	public static boolean isOwner(Player p) {
		return p.getAttributes().get("ownerkey") != null || p.getUsername().equalsIgnoreCase("Mikey") || p.getUsername().equalsIgnoreCase("Chris");
	}
