package com.atarx.rs2.entity.player;
...
import com.atarx.core.task.impl.FinishTeleportingTask;
import com.atarx.core.util.FileHandler;
import com.atarx.core.util.Utility;
import com.atarx.core.util.Utility.Stopwatch;
import com.atarx.core.util.NameUtil;
import com.atarx.rs2.content.Emotes;
import com.atarx.rs2.content.Inventory;
import com.atarx.rs2.content.LoyaltyShop;
import com.atarx.rs2.content.MoneyPouch;
import com.atarx.rs2.content.PlayerProperties;
import com.atarx.rs2.content.PlayerTitle;
import com.atarx.rs2.content.PriceChecker;
import com.atarx.rs2.content.PrivateMessaging;
import com.atarx.rs2.content.RunEnergy;
import com.atarx.rs2.content.achievements.AchievementList;
import com.atarx.rs2.content.bank.Bank;
import com.atarx.rs2.content.clanchat.Clan;
import com.atarx.rs2.content.combat.Combat.CombatTypes;
import com.atarx.rs2.content.combat.CombatInterface;
import com.atarx.rs2.content.combat.Hit;
import com.atarx.rs2.content.combat.PlayerCombatInterface;
import com.atarx.rs2.content.combat.impl.Skulling;
import com.atarx.rs2.content.combat.impl.SpecialAttack;
import com.atarx.rs2.content.consumables.Consumables;
import com.atarx.rs2.content.dialogue.Dialogue;
import com.atarx.rs2.content.dialogue.impl.Tutorial;
import com.atarx.rs2.content.dwarfcannon.DwarfMultiCannon;
import com.atarx.rs2.content.interfaces.InterfaceHandler;
import com.atarx.rs2.content.interfaces.impl.CreditTab;
import com.atarx.rs2.content.interfaces.impl.MiscInterfaces;
import com.atarx.rs2.content.interfaces.impl.QuestTab;
import com.atarx.rs2.content.io.PlayerSave;
import com.atarx.rs2.content.io.PlayerSaveUtil;
import com.atarx.rs2.content.membership.CreditPurchase;
import com.atarx.rs2.content.minigames.PlayerMinigames;
import com.atarx.rs2.content.minigames.barrows.Barrows;
import com.atarx.rs2.content.minigames.barrows.Barrows.Brother;
import com.atarx.rs2.content.minigames.duelarena.Dueling;
import com.atarx.rs2.content.minigames.fightcave.TzharrDetails;
import com.atarx.rs2.content.minigames.fightcave.TzharrGame;
import com.atarx.rs2.content.minigames.godwars.GodWarsData;
import com.atarx.rs2.content.minigames.godwars.GodWarsData.GodWarsNpc;
import com.atarx.rs2.content.minigames.weapongame.WeaponGame;
import com.atarx.rs2.content.pets.BossPets;
import com.atarx.rs2.content.shopping.Shopping;
import com.atarx.rs2.content.skill.Skill;
...
import com.atarx.rs2.content.skill.magic.weapons.TridentOfTheSeas;
import com.atarx.rs2.content.skill.magic.weapons.TridentOfTheSwamp;
import com.atarx.rs2.content.skill.melee.Melee;
import com.atarx.rs2.content.skill.melee.SerpentineHelmet;
import com.atarx.rs2.content.skill.prayer.PrayerBook;
import com.atarx.rs2.content.skill.prayer.PrayerBook.Prayer;
import com.atarx.rs2.content.skill.ranged.RangedSkill;
import com.atarx.rs2.content.skill.ranged.ToxicBlowpipe;
import com.atarx.rs2.content.skill.slayer.Slayer;
import com.atarx.rs2.content.skill.summoning.Summoning;
import com.atarx.rs2.content.trading.Trade;
import com.atarx.rs2.content.wilderness.TargetSystem;
import com.atarx.rs2.entity.Entity;
import com.atarx.rs2.entity.InterfaceManager;
import com.atarx.rs2.entity.Location;
import com.atarx.rs2.entity.World;
import com.atarx.rs2.entity.following.Following;
import com.atarx.rs2.entity.following.PlayerFollowing;
import com.atarx.rs2.entity.item.Equipment;
import com.atarx.rs2.entity.item.EquipmentConstants;
import com.atarx.rs2.entity.item.ItemDegrading;
import com.atarx.rs2.entity.item.impl.LocalGroundItems;
import com.atarx.rs2.entity.mob.Mob;
import com.atarx.rs2.entity.mob.MobConstants;
import com.atarx.rs2.entity.mob.RareDropEP;
import com.atarx.rs2.entity.movement.MovementHandler;
import com.atarx.rs2.entity.movement.PlayerMovementHandler;
import com.atarx.rs2.entity.object.LocalObjects;
import com.atarx.rs2.entity.player.controllers.Controller;
import com.atarx.rs2.entity.player.controllers.ControllerManager;
import com.atarx.rs2.entity.player.net.Client;
import com.atarx.rs2.entity.player.net.in.impl.ChangeAppearancePacket;
import com.atarx.rs2.entity.player.net.out.OutgoingPacket;
import com.atarx.rs2.entity.player.net.out.impl.SendConfig;
...
import com.atarx.rs2.entity.player.net.out.impl.SendLoginResponse;
import com.atarx.rs2.entity.player.net.out.impl.SendLogout;
import com.atarx.rs2.entity.player.net.out.impl.SendMapRegion;
import com.atarx.rs2.entity.player.net.out.impl.SendMessage;
import com.atarx.rs2.entity.player.net.out.impl.SendPlayerOption;
import com.atarx.rs2.entity.player.net.out.impl.SendRemoveInterfaces;
import com.atarx.rs2.entity.player.net.out.impl.SendSidebarInterface;
import com.atarx.rs2.entity.player.net.out.impl.SendSkillGoal;
import com.atarx.rs2.entity.player.net.out.impl.SendString;
import com.atarx.rs2.entity.player.net.out.impl.SendWalkableInterface;
...
public class Player extends Entity {
	...
	public void addDefaultChannel() {
		if (clan == null) {
			Clan localClan = Server.clanManager.getClan("ataratix");
			if (localClan != null)
	...
	public boolean login(boolean starter) throws Exception {
		...
		send(new SendMessage("Welcome testers!"));

		if (World.getActivePlayers() > ataratixConstants.MOST_ONLINE) {
			ataratixConstants.MOST_ONLINE = World.getActivePlayers();
			FileHandler.saveMaxPlayers();
			World.sendGlobalMessage("[<col=910D0D>ataratix</col>] We have broken our most players online record! New record: <col=910D0D>" + ataratixConstants.MOST_ONLINE + "</col>!");
		}
		
		if (ataratixConstants.doubleExperience) {			
