...
import com.atarx.core.definitions.ItemDropDefinition.ItemDropTable;
...
import com.atarx.rs2.content.cluescroll.ClueScroll;
import com.atarx.rs2.content.cluescroll.ClueScrollManager;
import com.atarx.rs2.content.cluescroll.scroll.EmoteScroll;
...
import com.atarx.rs2.entity.player.net.out.impl.SendKillFeed;
...
public class MobDrops {
	...
	public static void drop(Entity entity, Mob mob, ItemDropDefinition.ItemDropTable table, Location dropLocation) {
		if ((table != null) && (table.getDrops() != null)) {
			...
			if (!entity.isNpc()) {
				if (item.getDefinition().getGeneralPrice() >= 1) {
