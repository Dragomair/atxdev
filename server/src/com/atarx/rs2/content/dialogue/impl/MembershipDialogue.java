...
import com.atarx.rs2.content.dialogue.DialogueConstants;
...
public class MembershipDialogue extends Dialogue {
	...
	public boolean clickButton(int id) {
		...
		case DialogueConstants.OPTIONS_5_2:
			player.send(new SendString("http://www.ataratix.com/topic/204-membership-information/?p=1498", 12000));
			break;
	...
	public void execute() {
		...
		case 1:
			...
			break;
		case 2:
			DialogueManager.sendNpcChat(player, 5523, Emotion.DEFAULT, "ataratix credits can be purchased on our online store.", "They can be used for buying items from my store ", "and many other features in game.", "Including purchasing credits in the credits tab.");
			setNext(1);
			break;
		case 3:
