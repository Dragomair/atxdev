package com.atarx.rs2.content.dialogue.impl;
...
import com.atarx.rs2.entity.player.controllers.DefaultController;
...
public class Tutorial extends Dialogue {
	...
	public void execute() {
		...
		case 0:
			DialogueManager.sendNpcChat(player, GUIDE, Emotion.HAPPY_TALK, "Hello @blu@" + player.getUsername() + "</col>, Welcome to ataratix!", "Would you like a tutorial of our lands?");
			next++;
			break;
		case 1:
		...
		case 2:
			...
			break;
		case 3:
			nChat(new String[] {"Hello @blu@" + player.getUsername() + "</col>, Welcome to ataratix!", "Let's get started with the tutorial!"});
			break;
		case 4:
		...
		case 7:
			tele(3098, 3498);
			nChat(new String[] { "This is our exchange post.", "They are located all over ataratix.", "You may sell/buy items from other players here." });
			break;
		case 8:
			tele(3096, 3505);
		...
		case 14:
			...
			break;
		case 15:
			nChat(new String[] { "You may view the rules on our forums (@red@www.ataratix.com</col>)", "Make sure to vote to keep the server active." });
			break;
		case 16:
