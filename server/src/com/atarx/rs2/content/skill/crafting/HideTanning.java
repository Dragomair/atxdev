...
public class HideTanning {
	public static final int[][] TANNING_HIDE = { { 1739, 1741, 2 }, { 1739, 1743, 3 }, { 6287, 6289, 45 }, { 1753, 1745, 45 }, { 1751, 2505, 45 }, { 1749, 2507, 45 }, { 1747, 2509, 45 } };
	...
	public static final void sendTanningInterface(Player player) {
		for (int i = 0; i < TANNING_HIDE.length; i++) {
			...
			player.getClient().queueOutgoingPacket(new SendString(Item.getDefinition(TANNING_HIDE[i][1]).getName(), 14777 + i));
