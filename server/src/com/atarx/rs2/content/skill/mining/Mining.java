package com.atarx.rs2.content.skill.mining;
...
public class Mining {
	...
	public static enum Ore {
		COPPER("Copper ore", new int[] { 13708, 13709 }, 1, 17.5, new int[] { 436 }, 10081, 1, 4),
		TIN("Tin ore", new int[] { 13712, 13713 }, 1, 17.5, new int[] { 438 }, 10081, 1, 4),
		IRON("Iron ore", new int[] { 13710, 13711 }, 15, 35, new int[] { 440 }, 10081, 1, 7),
		SILVER_ORE("Silver ore", new int[] { 13716, 13717 }, 20, 40, new int[] { 442 }, 10081, 1, 10),
		COAL_ORE("Coal ore", new int[] { 13706, 13714 }, 30, 50, new int[] { 453 }, 10081, 2, 10),
		GOLD_ORE("Gold ore", new int[] { 13707, 13715 }, 40, 65, new int[] { 444 }, 10081, 3, 10),
		MITHRIL_ORE("Mithril ore", new int[] { 13718, 13719 }, 55, 80, new int[] { 447 }, 10081, 5, 13),
		ADAMANT_ORE("Adamant ore", new int[] { 13720, 14168 }, 70, 95, new int[] { 449 }, 10081, 5, 16),
		RUNITE_ORE("Runite ore", new int[] { 14175 }, 85, 125, new int[] { 451 }, 10081, 12, 18),
