...
public class AmmoData {
	...
	public static enum Ammo {
		...
		STEEL_ARROW(new int[] { 886, 887, 5618, 5624 }, Graphic.highGraphic(20, 0), Graphic.highGraphic(1106, 0)			, new Projectile(11)),
		MITHRIL_ARROW(new int[] { 888, 889, 5619, 5625 }, Graphic.highGraphic(21, 0), Graphic.highGraphic(1107, 0)		, new Projectile(12)),
		ADAMANT_ARROW(new int[] { 890, 891, 5620, 5626 }, Graphic.highGraphic(22, 0), Graphic.highGraphic(1108, 0)		, new Projectile(13)),
