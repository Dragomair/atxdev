package com.atarx.rs2.content.skill.ranged;
...
public class RangedConstants {
	...
	public static Graphic getDrawbackGraphic(Player player) {
		...
		case THROWN:
			switch (weapon.getId()) {
			case 811:
				return new Graphic(65535, 12, 100);
			case 810:
				return new Graphic(65535, 12, 100);
			case 809:
				return new Graphic(65535, 12, 100);
			...
			case 806:
				return new Graphic(65535, 12, 100);
			case 805:
				return new Graphic(48, 0, 100);
			case 804:
				return new Graphic(46, 0, 100);
			case 803:
				return new Graphic(45, 0, 100);
			case 802:
				return new Graphic(44, 0, 100);
			case 801:
				return new Graphic(42, 0, 100);
			case 800:
				return new Graphic(43, 0, 100);
			case 830:
				return new Graphic(211, 1, 100);
			case 829:
				return new Graphic(210, 1, 100);
			case 828:
				return new Graphic(209, 1, 100);
			case 827:
				return new Graphic(208, 1, 100);
			case 826:
				return new Graphic(207, 1, 100);
			case 825:
				return new Graphic(206, 1, 100);
			case 11230:
			case 11231:
	...
	public static Projectile getProjectile(Player player) {
		...
		case SHOT:
			...
			case 12926:
				...
				switch (player.getToxicBlowpipe().getBlowpipeAmmo().getId()) {
				case 11231:
					return new Projectile(1122);
				case 811:
					return new Projectile(237);
				case 810:
		...
		case THROWN:
			switch (weapon.getId()) {
			case 10034:
				return new Projectile(909);
			case 10033:
				return new Projectile(908);
			case 13879:
			case 13882:
