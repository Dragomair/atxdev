package com.atarx.rs2.content.skill;

import static com.atarx.rs2.content.skill.Skills.DUNGEONEERING;
...
import com.atarx.rs2.entity.player.net.out.impl.SendInterfaceConfig;
import com.atarx.rs2.entity.player.net.out.impl.SendMessage;
import com.atarx.rs2.entity.player.net.out.impl.SendSkill;
...
public class Skill {
	...
	private int ironMeleeExp = 55;
	private int ironRangeExp = 55;
	private int ironMagicExp = 55;
	...
	private int ultimateMeleeExp = 50;
	private int ultimateRangeExp = 50;
	private int ultimateMagicExp = 50;
	
	/**
	 * Player XP Rates
	 */
	
	private int meleeExp = 135;
	private int rangeExp = 110;
	private int magicExp = 125;
	...
	public void addCombatExperience(CombatTypes type, int hit) {
		...
		case MELEE:
			...
			case ACCURATE:
				if(player.isUltimateIron()) {
					addExperience(0, exp * ultimateMeleeExp);
				} else if (player.ironPlayer()) {
					addExperience(0, exp * ironMeleeExp);
				} else {
			...
			case AGGRESSIVE:
				...
				if(player.isUltimateIron()) {
					addExperience(2, exp * ultimateMeleeExp);
				} else if (player.ironPlayer()) {
					addExperience(2, exp * ironMeleeExp);
				} else {
			...
			case CONTROLLED:
				if (player.isUltimateIron()) {
					addExperience(0, (exp / 3.0D) * ultimateMeleeExp);
					addExperience(2, (exp / 3.0D) * ultimateMeleeExp);
					addExperience(1, (exp / 3.0D) * ultimateMeleeExp);
				} else if (player.ironPlayer()) {
					addExperience(0, (exp / 3.0D) * ironMeleeExp);
					addExperience(2, (exp / 3.0D) * ironMeleeExp);
					addExperience(1, (exp / 3.0D) * ironMeleeExp);
				} else {
			...
			case DEFENSIVE:
				if (player.isUltimateIron()) {
					addExperience(1, exp * ultimateMeleeExp);
				} else if (player.ironPlayer()) {
					addExperience(1, exp * ironMeleeExp);
				} else {
		...
		case MAGIC:
			if (player.isUltimateIron()) {
				addExperience(6, exp * ultimateMagicExp);
			} else if (player.ironPlayer()) {
				addExperience(6, exp * ironMagicExp);
			} else {
		...
		case RANGED:
			if (player.isUltimateIron()) {
				addExperience(4, exp * ultimateRangeExp);
			} else if (player.ironPlayer()) {
				addExperience(4, exp * ironRangeExp);
			} else {
			...
			case DEFENSIVE:
				...
				if (player.isUltimateIron()) {
					addExperience(4, exp / 2.0D * ultimateRangeExp);
					addExperience(1, exp / 2.0D * ultimateRangeExp);
				} else if (player.ironPlayer()) {
					addExperience(4, exp / 2.0D * ironRangeExp);
					addExperience(1, exp / 2.0D * ironRangeExp);
				} else {
		...
		if (player.isUltimateIron()) {
			addExperience(3, hit * ultimateMeleeExp * 1.33D);
		} else if (player.ironPlayer()) {
			addExperience(3, hit * ironMeleeExp * 1.33D);
		} else {
