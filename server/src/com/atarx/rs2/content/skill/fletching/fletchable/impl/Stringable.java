package com.atarx.rs2.content.skill.fletching.fletchable.impl;

import com.atarx.rs2.content.skill.fletching.Fletching;
import com.atarx.rs2.content.skill.fletching.fletchable.Fletchable;
import com.atarx.rs2.content.skill.fletching.fletchable.FletchableItem;
...
public enum Stringable implements Fletchable {
	...
	BRONZE_CROSSBOWS(new Item(1777), new Item(9454), new FletchableItem(new Item(9174), 9, 6.0)),
	IRON_CROSSBOWS(new Item(1777), new Item(9457), new FletchableItem(new Item(9177), 39, 22.0)),
	STEEL_CROSSBOWS(new Item(1777), new Item(9459), new FletchableItem(new Item(9179), 46, 27.0)),
	MITHRIL_CROSSBOWS(new Item(1777), new Item(9461), new FletchableItem(new Item(9181), 54, 32.0)),
	ADAMANT_CROSSBOWS(new Item(1777), new Item(9463), new FletchableItem(new Item(9183), 61, 41.0)),
	RUNITE_CROSSBOWS(new Item(1777), new Item(9465), new FletchableItem(new Item(9185), 61, 41.0));
