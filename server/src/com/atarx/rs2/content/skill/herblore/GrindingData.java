...
public enum GrindingData {
	UNICORN_HORN(237, 235), CHOCOLATE_BAR(1973, 1975), BIRDS_NEST(5075, 6693), KEBBIT_TEETH(
			10109, 10111), BLUE_DRAGON_SCALE(243, 241), DIAMOND_ROOT(14703,
			14704), DESERT_GOAT_HORN(9735, 9736), RUNE_SHARDS(6466, 6467);
