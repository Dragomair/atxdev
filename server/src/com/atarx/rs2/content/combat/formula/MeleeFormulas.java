package com.atarx.rs2.content.combat.formula;
...
public class MeleeFormulas {
	...
	public static double getDefenceRoll(Entity attacking, Entity defending) {
		Player blocker = null;
		if (!defending.isNpc()) {
			blocker = com.atarx.rs2.entity.World.getPlayers()[defending.getIndex()];
		} else {
	...
	public static double getEffectiveDefence(Entity entity) {
		Player blocker = null;
		if (!entity.isNpc()) {
			blocker = com.atarx.rs2.entity.World.getPlayers()[entity.getIndex()];
		} else {
	...
	public static double getAttackRoll(Entity entity) {
		...
		if (!entity.isNpc()) {
			attacker = com.atarx.rs2.entity.World.getPlayers()[entity.getIndex()];
	...
	public static double calculateBaseDamage(Player player) {
		...
		if (((helm != null) && (helm.getId() == 8921)) || ((helm != null) && (helm.getId() == 15492)) || ((helm != null) && (helm.getId() == 13263) && (defending.isNpc()) && (player.getSlayer().hasTask()))) {
			Mob m = com.atarx.rs2.entity.World.getNpcs()[defending.getIndex()];
