...
public class StarterKit {
	...
	public enum StarterData {
		...
		NORMAL(202051, 51766, 0, new Item[] { new Item(995, 500000), new Item(386, 75), new Item(2437, 10), new Item(2441, 10), new Item(2443, 10), new Item(2445, 10), new Item(3041, 10), new Item(3025, 10), new Item(1323, 1), new Item(1333, 1), new Item(4587, 1), new Item(1215, 1), new Item(841, 1), new Item(853, 1), new Item(861, 1), new Item(884, 500), new Item(10025, 1), new Item(3105, 1), new Item(1725, 1), new Item(658, 1), new Item(544, 1), new Item(542, 1), new Item(1540, 1), new Item(4393, 1) }, "Play ataratix as a regular player.", "Players have access to everything available.", "No additional restrictions will be applied to your account"),
		IRON_MAN(202052, 51767, 11, new Item[] { new Item(1351, 1), new Item(590, 1), new Item(303, 1), new Item(315, 1), new Item(1925, 1), new Item(1931, 1), new Item(2309, 1), new Item(1265, 1), new Item(1205, 1), new Item(1277, 1), new Item(1171, 1), new Item(841, 1), new Item(882, 25), new Item(556, 25), new Item(558, 15), new Item(555, 6), new Item(557, 4), new Item(559, 2), new Item(12810, 1), new Item(12811, 1), new Item(12812, 1) }, "Play ataratix as an Iron Man.", "An Iron Man does not recieve items or assistance from other players. They cannot trade,", "stake, recieve PK loot, scavenge dropped items, nor play certain multiplayer minigames."),
		ULTIMATE_IRON_MAN(202053, 51768, 12, new Item[] {	new Item(1351, 1), new Item(590, 1), new Item(303, 1), new Item(315, 1), new Item(1925, 1), new Item(1931, 1), new Item(2309, 1), new Item(1265, 1), new Item(1205, 1), new Item(1277, 1), new Item(1171, 1), new Item(841, 1), new Item(882, 25), new Item(556, 25), new Item(558, 15), new Item(555, 6), new Item(557, 4), new Item(559, 2), new Item(12813, 1), new Item(12814, 1), new Item(12815, 1) }, "Play ataratix as an Ultimate Iron Man. ", "In addition to the standard Iron Man rules, an", "Ultimate Iron Man cannot use banks, nor retain any items on death in dangerous areas.");
