...
public class DuelingController extends Controller {
	...
	public Location getRespawnLocation(Player player) {
		Location p = DuelingConstants.RESPAWN_LOCATIONS[com.atarx.core.util.Utility.randomNumber(DuelingConstants.RESPAWN_LOCATIONS.length)];
		int[] dir = com.atarx.rs2.GameConstants.DIR[com.atarx.core.util.Utility.randomNumber(com.atarx.rs2.GameConstants.DIR.length)];
