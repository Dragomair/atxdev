package com.atarx.rs2.content.minigames.duelarena;
...
public class DuelingConstants {
	...
	public static final Location[] RESPAWN_LOCATIONS = { new Location(3363, 3276), new Location(3369, 3275), new Location(3373, 3275), new Location(3377, 3275), new Location(3377, 3275), new Location(3370, 3268), new Location(3363, 3268) };
	...
	public static final int[] DUEL_RULE_IDS = { 1, 2, 16, 32, 64, 128, 256, 512, 1024, 4096, 8192, 16384, 32768, 65536, 131072, 262144, 524288, 2097152, 8388608, 16777216, 67108864, 134217728 };
	...
	public static final boolean clickDuelButton(Player p, int id) {
		...
		case 26066:
			...
			return true;
		case 53245:
			p.getDueling().toggleRule(11);
			return true;
		case 53246:
			p.getDueling().toggleRule(12);
			return true;
		case 53247:
			p.getDueling().toggleRule(13);
			return true;
		case 53249:
			p.getDueling().toggleRule(14);
			return true;
		case 53250:
			p.getDueling().toggleRule(15);
			return true;
		case 53251:
			p.getDueling().toggleRule(16);
			return true;
		case 53252:
			p.getDueling().toggleRule(17);
			return true;
		case 53255:
			p.getDueling().toggleRule(18);
			return true;
		case 53254:
			p.getDueling().toggleRule(19);
			return true;
		case 53253:
			p.getDueling().toggleRule(20);
			return true;
		case 53248:
			p.getDueling().toggleRule(21);
			return true;
		}
		return false;
	}
	...
	public static final String getStakedItemsToString(Item[] staked, int count) {
		...
		for (int i = 0; i < staked.length; i++) {
			...
			s = s + staked[i].getDefinition().getName() + " x " + formatAmount(staked[i].getAmount()) + ((!altParse) || ((altParse) && ((i + 1) % 2 == 0)) ? "\\n" : " ");
		}
