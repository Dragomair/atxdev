...
public class FightPitsConstants {
	...
	public static final Location INTO_WAITING_LOCATION = new Location(2399,
			5175);
	public static final Location OUT_OF_WAITING_LOCATION = new Location(2399,
			5177);
	...
	public static final int[] FIGHT_PITS_INTERFACE_STRINGS = { 17601, 17602,
			17603, 17604, 17605 };
