package com.atarx.core.cache.map;
...
import com.atarx.core.cache.ByteStreamExt;

public final class RSInterface {

	private static final Map<Integer, Short> songs = new HashMap<Integer, Short>();

	private static String[] musicNames = { "7th Realm", "A Familiar Feeling",
			"A New Menace", "A Pirate's Life for Me", "Adorno I", "Adorno II",
			"Adorno III", "Adorno IV", "Adorno IX", "Adorno V", "Adorno VI",
			"Adorno VII", "Adorno VIII", "Adorno X", "Adventure", "Al Kharid",
			"All's Fairy in Love and War", "Alone", "Altar Ego",
			"Alternative Root", "Ambient Jungle", "An Easter United",
			"Ancestral Wisdom", "Animal Apogee", "Anywhere", "Arabian",
			"Arabian 2", "Arabian 3", "Arabique", "Ardougne Ago",
			"Arma Gonna Get You", "Armadyl Alliance", "Armageddon",
			"Army of Darkness", "Arrival", "Artistry", "Assault and Battery",
			"Attack 1", "Attack 2", "Attack 3", "Attack 4", "Attack 5",
			"Attack 6", "Attention", "Autumn Voyage", "Aye Car Rum Ba",
			"Aztec", "Back to Life", "Background", "Bal'lak the Pummeller",
			"Ballad of Enchantment", "Bandit Camp", "Bandos Battalion",
			"Bane of Summer", "Barb Wire", "Barbarianism", "Barking Mad",
			"Baroque", "Battle of Souls", "Beetle Juice", "Beyond",
			"Big Chords", "Bish Bash Bosh", "Bittersweet Bunny",
			"Black of Knight", "Blistering Barnacles", "Bloodbath",
			"Body Parts", "Bolrie's Diary", "Bone Dance", "Bone Dry",
			"Book of Spells", "Borderland", "Born to Do This",
			"Bounty Hunter Level 1", "Bounty Hunter Level 2",
			"Bounty Hunter Level 3", "Brain Battle", "Breeze", "Brew Hoo Hoo",
			"Brimstail's Scales", "Bubble and Squeak", "Bulwark Beast",
			"But We Can Fight", "Cabin Fever", "Camelot", "CastleWars",
			"Catacombs and Tombs", "Catch Me If You Can", "Cave Background",
			"Cave of Beasts", "Cave of the Goblins", "Cavern",
			"Cavernous Mythology", "Cellar Song", "Chain of Command",
			"Chamber", "Charmin' Farmin'", "Chef Surprize", "Chickened Out",
			"Chompy Hunt", "Circus", "City of the Dead", "Clan Wars",
			"Claustrophobia", "Close Quarters", "Command Centre",
			"Competition", "Complication", "Conspiracy: Part 1",
			"Conspiracy: Part 2", "Contest", "Cool for Ali Cats",
			"Copris Lunaris", "Corporal Punishment", "Corridors of Power",
			"Courage", "Creature Cruelty", "Creepy", "Crystal Castle",
			"Crystal Cave", "Crystal Sword", "Cursed", "Dagannoth Dawn",
			"Dance of Death", "Dance of the Undead", "Dangerous",
			"Dangerous Logic", "Dangerous Road", "Dangerous Way", "Dark",
			"Davy Jones's Locker", "Dead and Buried", "Dead Can Dance",
			"Dead Quiet", "Deadlands", "Deep Down", "Deep Wildy",
			"Demise of the Dorgeshuun", "Desert Heat", "Desert Island Bear",
			"Desert Smoke", "Desert Voyage", "Desolate Ruins", "Desolo I",
			"Desolo II", "Desolo III", "Desolo IV", "Desolo IX", "Desolo V",
			"Desolo VI", "Desolo VII", "Desolo VIII", "Desolo X",
			"Diango's Little Helpers", "Dillo-gence is Key", "Dimension X",
			"Distant Land", "Distillery Hilarity", "Divine Skinweaver",
			"Dogs of War", "Don't Panic Zanik", "Doorways", "Dorgeshuun City",
			"Dorgeshuun Deep", "Down and Out", "Down Below", "Down to Earth",
			"Dragontooth Island", "Dream", "Dream Theatre", "Dreamstate",
			"Duel Arena", "Dunjun", "Dusk in Yu'biusk", "Dwarf Theme",
			"Dynasty", "Eagle Peak", "Easter Jig", "Egypt", "Elven Mist",
			"Elven Seed", "Emotion", "Emperor", "Eruption", "Escape",
			"Espionage", "Etcetera", "Everlasting", "Everlasting Fire",
			"Everywhere", "Evil Bob's Island", "Exam Conditions",
			"Exhibit 'A'", "Expanse", "Expecting", "Expedition", "Exposed",
			"Face Off", "Faerie", "Faithless", "Fanfare", "Fanfare 2",
			"Fanfare 3", "Fangs for the Memory", "Far Away", "Fe Fi Fo Fum",
			"Fear and Loathing", "Fenkenstrain's Refrain",
			"Fight of the Dwarves", "Fight or Flight", "Final Destination",
			"Find My Way", "Fire and Brimstone", "Fishing", "Floating Free",
			"Flute Salad", "Food for Thought", "Forbidden", "Forest",
			"Forever", "Forgettable Melody", "Forgotten", "Freshwater",
			"Frogland", "Frost Fight", "Frostbite", "Fruits de Mer",
			"Funny Bunnies", "Gaol", "Garden", "Garden of Autumn",
			"Garden of Spring", "Garden of Summer", "Garden of Winter",
			"Ghost of Christmas Presents", "Glacialis IV", "Glacialis VI",
			"Glacialis VIII", "Glorious Recallation...",
			"Glorious Recallation...", "Glorious Recallation...", "Gnome King",
			"Gnome Village", "Gnome Village 2", "Gnomeball", "Goblin Game",
			"Goblin Village", "Godslayer", "Golden Touch", "Greatness",
			"Grimly Fiendish", "Grip of the Talon", "Grotto", "Ground Scape",
			"Grumpy", "Guthix's Hunter", "H.A.M. Fisted", "Ham and Seek",
			"Ham Attack", "Har'Lakk the Riftsplitter", "Hare-brained Bitches",
			"Harmony", "Harmony 2", "Haunted Mine", "Have a Blast",
			"Have an Ice Day", "Head to Head", "Healin' Feelin'",
			"Heart and Mind", "Hell's Bells", "Hermit", "High Seas",
			"High Spirits", "Historic Memories", "Hobgoblin Geomancer",
			"Home Sweet Home", "Homescape", "Honkytonky Harmony",
			"Honkytonky Medieval", "Honkytonky Newbie Melody",
			"Honkytonky Parade", "Honkytonky Sea Shanty", "Horizon",
			"Hot 'n' Bothered", "Hypnotized", "I'm Counting on You", "Iban",
			"Ice Day for Penguins", "Ice Melody", "Icy a Worried Gnome",
			"Icy Trouble Ahead", "Illusive", "Impetuous", "In Between",
			"In the Brine", "In the Clink", "In the Manor", "In the Pits",
			"Inadequacy", "Incantation", "Incarceration", "Insect Queen",
			"Inspiration", "Into the Abyss", "Intrepid", "Island Life",
			"Island of the Trolls", "Isle of Everywhere", "Itsy Bitsy...",
			"Jailbird", "Jaws of the Dagannoth", "Jester Minute", "Jolly-R",
			"Joy of the Hunt", "Jungle Bells", "Jungle Community",
			"Jungle Hunt", "Jungle Island", "Jungle Island XMAS",
			"Jungle Troubles", "Jungly 1", "Jungly 2", "Jungly 3",
			"Karamja Jam", "Kharidian Nights", "Kingdom", "Knightly",
			"Knightmare", "La Mort", "Labyrinth", "Lair", "Lair of Kang Admi",
			"Lament", "Lament of Meiyerditch", "Lamistard's Labyrinth",
			"Land Down Under", "Land of Snow", "Land of the Dwarves",
			"Landlubber", "Last Stand", "Lasting", "Lazy Wabbit", "Legend",
			"Legion", "Lexicus Runewright", "Life's a Beach!", "Lighthouse",
			"Lightness", "Lightwalk", "Little Cave of Horrors", "Living Rock",
			"Lonesome", "Long Ago", "Long Way Home", "Looking Back",
			"Lore and Order", "Lost Soul", "Lullaby", "Mad Eadgar",
			"Mage Arena", "Magic and Mystery", "Magic Dance",
			"Magic Magic Magic", "Magical Journey", "Maiasaura", "Major Miner",
			"Making Waves", "Malady", "March", "Marooned", "Marzipan",
			"Masquerade", "Mastermindless", "Mausoleum", "Meddling Kids",
			"Medieval", "Mellow", "Melodrama", "Melzar's Maze", "Meridian",
			"Method of Madness", "Miles Away", "Mind Over Matter",
			"Miracle Dance", "Mirage", "Miscellania", "Mobilising Armies",
			"Monarch Waltz", "Monkey Madness", "Monster Melee", "Moody",
			"Morytania", "Mouse Trap", "Mudskipper Melody", "Mutant Medley",
			"My Arm's Journey", "Narnode's Theme", "Natural", "Neverland",
			"Newbie Melody", "Nial's Widow", "Night of the Vampyre",
			"Night-gazer Khighorahk", "Nightfall", "No Way Out", "Nomad",
			"Norse Code", "Null and Void", "Ogre the Top", "On the Up",
			"On the Wing", "Oriental", "Out of the Deep", "Over To Nardah",
			"Overpass", "Overture", "Parade", "Path of Peril", "Pathways",
			"Penguin Possible", "Pest Control", "Pharaoh's Tomb", "Phasmatys",
			"Pheasant Peasant", "Pinball Wizard", "Pirates of Penance",
			"Pirates of Peril", "Poison Dreams", "Poles Apart", "Prime Time",
			"Principality", "Quest", "Rammernaut", "Rat a Tat Tat", "Rat Hunt",
			"Ready for Battle", "Regal", "Reggae", "Reggae 2", "Rellekka",
			"Rest for the Weary", "Right on Track", "Righteousness",
			"Rising Damp", "Riverside", "Roc and Roll", "Roll the Bones",
			"Romancing the Crone", "Romper Chomper", "Roots and Flutes",
			"Royale", "Rune Essence", "Sad Meadow", "Safety in Numbers",
			"Saga", "Sagittare", "Saltwater", "Sarah's Lullaby", "Sarcophagus",
			"Sarim's Vermin", "Scape Cave", "Scape Hunter", "Scape Main",
			"Scape Original", "Scape Sad", "Scape Santa", "Scape Scared",
			"Scape Soft", "Scape Summon", "Scape Theme", "Scape Wild",
			"Scarab", "Scarabaeoidea", "School's Out", "Sea Shanty",
			"Sea Shanty 2", "Sea Shanty XMAS", "Second Vision", "Serenade",
			"Serene", "Settlement", "Shadow-forger Ihlakhizan", "Shadowland",
			"Shaping Up", "Shine", "Shining", "Shining Spirit", "Shipwrecked",
			"Showdown", "Sigmund's Showdown", "Silent Knight",
			"Slain to Waste", "Slice of Silent Movie", "Slice of Station",
			"Slither and Thither", "Slug a Bug Ball", "Smorgasbord", "Sojourn",
			"Something Fishy", "Soundscape", "Spa Bizarre", "Sphinx", "Spirit",
			"Spirits of Elid", "Splendour", "Spooky", "Spooky 2",
			"Spooky Jungle", "Stagnant", "Starlight", "Start",
			"Stealing Creation", "Still Night", "Stillness", "Stillwater",
			"Stomp", "Storeroom Shuffle", "Storm Brew", "Stranded",
			"Strange Place", "Stratosphere", "Strength of Saradomin",
			"Subterranea", "Sunburn", "Superstition", "Surok's Theme",
			"Suspicious", "Tale of Keldagrim", "Talking Forest",
			"Tears of Guthix", "Technology", "Temple", "Temple Desecrated",
			"Temple of Light", "Temple of Tribes", "Terrorbird Tussle",
			"The Adventurer", "The Adventurers Re-United!",
			"The Art of Hocus-Pocus", "The Cellar Dwellers", "The Chosen",
			"The Chosen Commander", "The Columbarium",
			"The Dance of the Snow Queen", "The Depths", "The Desert",
			"The Desolate Isle", "The Duke", "The Enchanter",
			"The Evil Within", "The Fallen Hero", "The Far Side",
			"The Galleon", "The Genie", "The Golem", "The Heist",
			"The Horn of Chill", "The Last Shanty", "The Longramble Scramble",
			"The Lost Melody", "The Lost Tribe", "The Lunar Isle",
			"The Mad Mole", "The Mentor", "The Mollusc Menace",
			"The Monsters Below", "The Muspah's Tomb", "The Navigator",
			"The Noble Rodent", "The Other Side", "The Pact",
			"The Pengmersible", "The Phoenixb", "The Plundered Tomb",
			"The Power of Tears", "The Quiz Master", "The Rogues' Den",
			"The Route of All Evil", "The Route of the Problem",
			"The Ruins of Camdozaal", "The Shadow", "The Slayer",
			"The Sound of Guthix", "The Terrible Caverns",
			"The Terrible Tower", "The Terrible Tunnels",
			"The Throne of Bandos", "The Tower", "The Trade Parade",
			"The Vacant Abyss", "The Wrong Path", "Theme", "These Stones",
			"Throne of the Demon", "Time Out", "Time to Mine", "Tiptoe",
			"Title Fight", "TokTz-Ket-Ek-Mack", "Tomb Raider", "Tomorrow",
			"Too Many Cooks...", "Tournament!", "Trawler", "Trawler Minor",
			"Tree Spirits", "Trees Aren't Your Friends", "Tremble", "Tribal",
			"Tribal 2", "Tribal Background", "Trick or Treat?", "Trinity",
			"Trouble Brewing", "Troubled", "Troubled Spirit",
			"Tune from the Dune", "Twilight", "TzHaar!", "Undead Army",
			"Undead Dungeon", "Under the Sand", "Undercurrent", "Underground",
			"Underground Pass", "Understanding", "Unholy Cursebearer",
			"Unknown Land", "Untouchable", "Upcoming", "Venomous", "Venture",
			"Venture 2", "Victory is Mine", "Village", "Vision",
			"Volcanic Vikings", "Voodoo Cult", "Voyage", "Waiting for Battle",
			"Waiting for the Hunt", "Waking Dream", "Wander", "Warrior",
			"Warriors' Guild", "Waste Defaced", "Waterfall", "Waterlogged",
			"Way of the Enchanter", "Wayward", "We Are the Fairies",
			"Well of Voyage", "Where Eagles Lair", "Wild Isle", "Wild Side",
			"Wilderness", "Wilderness 2", "Wilderness 3", "Wildwood",
			"Winter Funfare", "Witching", "Woe of the Wyvern", "Wonder",
			"Wonderous", "Woodland", "Work Work Work", "Workshop",
			"Wrath and Ruin", "Xenophobe", "Yesteryear", "Zamorak Zoo",
			"Zanik's Theme", "Zaros Stirs", "Zealot", "Zogre Dance" };
	...
	public static void addHDHoveredButton(int i, String imageName, int j,
			int w, int h, int IMAGEID) {// hoverable
										// button
		RSInterface tab = addTabInterface(i);
		tab.parentID = i;
		tab.id = i;
	...
	public static void addHDSprite(int id, String spriteName, String T, int H,
			int X, int Y) {
	...
	public static void configureLunar() {
		...
		addLunar3RunesSmallBox(30040, 9075, 564, 556, 0, 0, 1, 30013, 30005,
				66, "Mob Contact", "Speak with varied NPCs", 3, 0, 2);
		...
		addLunar3RunesSmallBox(30064, 9075, 563, 557, -1, -1, -1, 30012, 30006,
				68, "Skill Teleport", "Skill Teleport", 6, 0, 5);
		addLunar3RunesBigBox(30075, 9075, 563, 557, -1, -1, -1, 30012, 30006,
				69, "Minigames", "Barrows & Assault", 7, 0, 5);
		addLunar3RunesSmallBox(30083, 9075, 563, 557, -1, -1, -1, 30012, 30006,
				70, "Boss Teleport", "Boss Teleport", 8, 0, 5);
		...
		addLunar3RunesSmallBox(30106, 9075, 563, 555, -1, -1, -1, 30012, 30004,
				71, "Pk Teleport", "Gives your several of options", 11, 0, 5);
		addLunar3RunesBigBox(30114, 9075, 563, 555, -1, -1, -1, 30012, 30004,
				72, "Monster Teleport", "Monster Teleport", 12, 0, 5);
		...
		addLunar3RunesBigBox(30138, 9075, 563, 554, -1, -1, -1, 30012, 30003,
				74, "Barbarian Teleport",
	...
	public static void addClickableText(int id, String text, String tooltip,
			int idx, int color, int hoverColor, int width, int height) {
	...
	public static void addPActionButton(int i, int j, int k, int width,
			int height, String s) {
	...
	public static void addPouch(int ID, int r1[], int ra1, int r2, int lvl,
			String name, int imageID, int type) {
		RSInterface rsInterface = addTabInterface(ID);
		rsInterface.id = ID;
		rsInterface.parentID = 1151;
		rsInterface.type = 5;
	...
	public static void Bank() {
		...
		addBankHover(21000, 4, 21001, 7, 8, "Interfaces/Bank/BANK", 35, 25,
				304, 1, "Swap Withdraw Mode", 21002, 7, 8,
	...
	public static void BuyandSell() {
		...
		addHoverButton(24541 + 150, "b", 3, 138, 108, "Abort offer", 0,
				24542 + 150, 1);
		addHoverButton(24543 + 150, "b", 3, 138, 108, "View offer", 0,
				24544 + 150, 1);
		addHoverButton(24545 + 150, "b", 3, 138, 108, "Abort offer", 0,
				24546 + 150, 1);
		addHoverButton(24547 + 150, "b", 3, 138, 108, "View offer", 0,
				24548 + 150, 1);
		addHoverButton(24549 + 150, "b", 3, 138, 108, "Abort offer", 0,
				24550 + 150, 1);
		addHoverButton(24551 + 150, "b", 3, 138, 108, "View offer", 0,
				24552 + 150, 1);
		addHoverButton(24553 + 150, "b", 3, 138, 108, "Abort offer", 0,
				24554 + 150, 1);
		addHoverButton(24555 + 150, "b", 3, 138, 108, "View offer", 0,
				24556 + 150, 1);
		addHoverButton(24557 + 150, "b", 3, 138, 108, "Abort offer", 0,
				24558 + 150, 1);
		addHoverButton(24559 + 150, "b", 3, 138, 108, "View offer", 0,
				24560 + 150, 1);
		addHoverButton(24561 + 150, "b", 3, 138, 108, "Abort offer", 0,
				24562 + 150, 1);
		addHoverButton(24563 + 150, "b", 3, 138, 108, "View offer", 0,
				24564 + 150, 1);
		...
		addHoverButton(24502 + 150, "Interfaces/GE/SPRITE", 1, 21, 21, "Close",
				250, 24503 + 150, 3);
		addHoveredButton(24503 + 150, "Interfaces/GE/SPRITE", 3, 21, 21, 24504);
		addHoverButton(24505 + 150, "Interfaces/GE/NEW", 2, 50, 50, "Buy", 0,
				24506 + 150, 1);
		addHoveredButton(24506 + 150, "Interfaces/GE/NEW", 4, 50, 50, 24507);
		addHoverButton(24508 + 150, "Interfaces/GE/NEW", 2, 50, 50, "Buy", 0,
				24509 + 150, 1);
		addHoveredButton(24509 + 150, "Interfaces/GE/NEW", 4, 50, 50, 24510);
		addHoverButton(24514 + 150, "Interfaces/GE/NEW", 2, 50, 50, "Buy", 0,
				24515 + 150, 1);
		addHoveredButton(24515 + 150, "Interfaces/GE/NEW", 4, 50, 50, 24516);
		addHoverButton(24517 + 150, "Interfaces/GE/NEW", 2, 50, 50, "Buy", 0,
				24518 + 150, 1);
		addHoveredButton(24518 + 150, "Interfaces/GE/NEW", 4, 50, 50, 24519);
		addHoverButton(24520 + 150, "Interfaces/GE/NEW", 2, 50, 50, "Buy", 0,
				24521 + 150, 1);
		addHoveredButton(24521 + 150, "Interfaces/GE/NEW", 4, 50, 50, 24522);
		addHoverButton(24523 + 150, "Interfaces/GE/NEW", 2, 50, 50, "Buy", 0,
				24524 + 150, 1);
		addHoveredButton(24524 + 150, "Interfaces/GE/NEW", 4, 50, 50, 24525);
		addHoverButton(24511 + 150, "Interfaces/GE/NEW", 3, 50, 50, "Sell", 0,
				24512 + 150, 1);
		addHoveredButton(24512 + 150, "Interfaces/GE/NEW", 5, 50, 50, 24513);
		addHoverButton(24526 + 150, "Interfaces/GE/NEW", 3, 50, 50, "Sell", 0,
				24527 + 150, 1);
		addHoveredButton(24527 + 150, "Interfaces/GE/NEW", 5, 50, 50, 24528);
		addHoverButton(24529 + 150, "Interfaces/GE/NEW", 3, 50, 50, "Sell", 0,
				24530 + 150, 1);
		addHoveredButton(24530 + 150, "Interfaces/GE/NEW", 5, 50, 50, 24531);
		addHoverButton(24532 + 150, "Interfaces/GE/NEW", 3, 50, 50, "Sell", 0,
				24533 + 150, 1);
		addHoveredButton(24533 + 150, "Interfaces/GE/NEW", 5, 50, 50, 24534);
		addHoverButton(24535 + 150, "Interfaces/GE/NEW", 3, 50, 50, "Sell", 0,
				24536 + 150, 1);
		addHoveredButton(24536 + 150, "Interfaces/GE/NEW", 5, 50, 50, 24537);
		addHoverButton(24538 + 150, "Interfaces/GE/NEW", 3, 50, 50, "Sell", 0,
				24539 + 150, 1);
		addHoveredButton(24539 + 150, "Interfaces/GE/NEW", 5, 50, 50,
				24540 + 150);
	...
	public static void editClan() {
		...
		addHoverButton(47252, "Interfaces/Clan Chat/BUTTON", 1, 150, 35,
				"Set name", 22222, 47253, 1);
		addHoveredButton(47253, "Interfaces/Clan Chat/BUTTON", 2, 150, 35,
				47254);
		addHoverButton(47255, "Interfaces/Clan Chat/BUTTON", 1, 150, 35,
				"Anyone", -1, 47256, 1);
		addHoveredButton(47256, "Interfaces/Clan Chat/BUTTON", 2, 150, 35,
				47257);
		...
		addHoverButton(47258, "Interfaces/Clan Chat/BUTTON", 1, 150, 35,
				"Anyone", -1, 47259, 1);
		addHoveredButton(47259, "Interfaces/Clan Chat/BUTTON", 2, 150, 35,
				17260);
		...
		addHoverButton(47261, "Interfaces/Clan Chat/BUTTON", 1, 150, 35,
				"Only me", -1, 47262, 1);
		addHoveredButton(47262, "Interfaces/Clan Chat/BUTTON", 2, 150, 35,
				47263);
		...
		addHoverButton(47267, "Interfaces/Clan Chat/CLOSE", 3, 16, 16, "Close",
				-1, 47268, 1);
	...
	public static void emoteTab() {
		...
		int EmoteX[] = { 10, 54, 98, 137, 9, 48, 95, 132, 7, 51, 95, 139, 6,
				50, 90, 135, 8, 51, 99, 137, 10, 53, 85, 138, 3, 52, 96, 141,
				5, 53, 88, 142, 10, 51, 139, 88, 12, 49, 97, 135, 10, 50, 90,
				130, 10, 60, 90 };
		int EmoteY[] = { 6, 6, 8, 6, 55, 55, 55, 55, 104, 104, 103, 104, 153,
				153, 153, 153, 203, 202, 203, 202, 250, 250, 252, 249, 300,
	...
	public static void friendsTab() {
		...
		addHoverButton(5073, "Interfaces/Kamiel/SPRITE", 3, 17, 17,
				"Add friend", 201, 5074, 1);
		addHoveredButton(5074, "Interfaces/Kamiel/SPRITE", 4, 17, 17, 5075);
		addHoverButton(5076, "Interfaces/Kamiel/SPRITE", 5, 17, 17,
				"Delete friend", 202, 5077, 1);
		addHoveredButton(5077, "Interfaces/Kamiel/SPRITE", 6, 17, 17, 5078);
		// addText(5079, "0 / 200", kam, 0, 0xF5F5DC, false, true, 901, 0);
		addButton(5080, 10, "Interfaces/Kamiel/SPRITE", "Show ignores tab", 17,
				17);
	...
	public static final int getParent(int id) {
		if (interfaceCache[id] == null || interfaceCache[id].parentID == -1
				|| interfaceCache[id].parentID == id)
			return id;
		else
	...
	public static void ignoreTab() {
		...
		addHoverButton(5721, "Interfaces/Kamiel/SPRITE", 11, 17, 17,
				"Add name", 501, 5722, 1);
		addHoveredButton(5722, "Interfaces/Kamiel/SPRITE", 12, 17, 17, 5723);
		addHoverButton(5724, "Interfaces/Kamiel/SPRITE", 13, 17, 17,
				"Delete name", 502, 5725, 1);
		...
		addButton(5729, 9, "Interfaces/Kamiel/SPRITE", "Show friends tab", 17,
				17);
	...
	public static final void plotSongList() {
		...
		try {
			...
			while ((line = reader.readLine()) != null) {
				...
				if (line.indexOf("e: ") == -1 || line.indexOf("id: ") == -1
						|| line.indexOf(" n") == -1) {
					continue;
				}

				try {
					name = line.substring(line.indexOf("e: ") + 2,
							line.length()).trim();
					id = Integer.parseInt(line.substring(
							line.indexOf("id: ") + 3, line.indexOf(" n"))
							.trim());
		...
		for (Integer i : musicInterface.children) {
			...
			if (child != null && child.children != null) {
				for (Integer j : child.children) {
					if (interfaceCache[j].message == null
							|| interfaceCache[j].message.equals("null")) {
						continue;
					}

					if (loaded.containsKey(interfaceCache[j].message
							.toLowerCase())) {
						songs.put(
								j,
								loaded.get(
										interfaceCache[j].message.toLowerCase())
										.shortValue());
	...
	public static void pouchCreation() {
		...
		for (int i = 0; i < totalScrolls; i++) {
			...
			addPouch(23480 + i * 8, req, 1, pouchItems[i],
					summoningLevelRequirements[i], pouchNames[i], i, 5);
	...
	public static void RingColourChange() {
		...
		addHover(29814, 3, 0, 29815, 0, "Interfaces/RingofKinship/CLOSE", 17,
				16, "Exit");
		addHovered(29815, 1, "Interfaces/RingofKinship/CLOSE", 17, 16, 29816);
		addHoverButton(29817, "Interfaces/RingofKinship/EXAMINE", 0, 72, 64,
				"Examine @or1@Ring of Kinship", -1, 29818, 1);
		addHoveredButton(29818, "Interfaces/RingofKinship/EXAMINE", 0, 72, 64,
				29819);
		addHoverButton(29820, "Interfaces/RingofKinship/EXAMINE", 0, 72, 64,
				"Examine @or1@Ring of Kinship", -1, 29821, 1);
		addHoveredButton(29821, "Interfaces/RingofKinship/EXAMINE", 0, 72, 64,
				29822);
		addHoverButton(29823, "Interfaces/RingofKinship/EXAMINE", 0, 72, 64,
				"Examine @or1@Ring of Kinship", -1, 29824, 1);
		addHoveredButton(29824, "Interfaces/RingofKinship/EXAMINE", 0, 72, 64,
				29825);
		addHoverButton(29826, "Interfaces/RingofKinship/EXAMINE", 0, 72, 64,
				"Examine @or1@Ring of Kinship", -1, 29827, 1);
		addHoveredButton(29827, "Interfaces/RingofKinship/EXAMINE", 0, 72, 64,
				29828);
		addHoverButton(29830, "Interfaces/RingofKinship/BUTTON", 2, 75, 23,
				"Buy", -1, 29831, 1);
		addHoveredButton(29831, "Interfaces/RingofKinship/BUTTON", 3, 75, 23,
				29832);
		addHoverButton(29833, "Interfaces/RingofKinship/BUTTON", 2, 75, 23,
				"Buy", -1, 29834, 1);
		addHoveredButton(29834, "Interfaces/RingofKinship/BUTTON", 3, 75, 23,
				29835);
		addHoverButton(29836, "Interfaces/RingofKinship/BUTTON", 2, 75, 23,
				"Buy", -1, 29837, 1);
		addHoveredButton(29837, "Interfaces/RingofKinship/BUTTON", 3, 75, 23,
				29838);
		addHoverButton(29839, "Interfaces/RingofKinship/BUTTON", 2, 75, 23,
				"Buy", -1, 29840, 1);
		addHoveredButton(29840, "Interfaces/RingofKinship/BUTTON", 3, 75, 23,
				29841);
	...
	public static void scrollCreation() {
		...
		for (int i = 0; i < totalScrolls; i++) {
			...
			addScroll(22769 + i * 9, pouchItems[i], 1, scrollItems[i],
					summoningLevelRequirements[i], scrollNames[i], i, 5);
	...
	public static void settingsInterface() {
		...
		addButton(26014, 4, -1, 2, 3, "Interfaces/settings/click", 15, 15,
				"Toggle day time", 654, 1);
		/**
		 * Fixed buttons
		 */
		addHoverButton(26016, "Interfaces/settings/full", 0, 50, 39,
				"Fixed Mode", -1, 26017, 1);
		addHoveredButton(26017, "Interfaces/settings/full", 1, 50, 39, 26018);
		/**
		 * Resizable buttons
		 */
		addHoverButton(26019, "Interfaces/settings/full", 2, 50, 39,
				"Resizable Mode", -1, 26020, 1);
		addHoveredButton(26020, "Interfaces/settings/full", 3, 50, 39, 26021);
		/**
		 * Fullscreen buttons
		 */
		addHoverButton(26022, "Interfaces/settings/full", 4, 50, 39,
				"Fullscreen Mode", -1, 26023, 1);
		...
		do {
			...
			if (i1 > 0) {
				...
				for (int j1 = 0; j1 < i1; j1++) {
					rsInterface.valueCompareType[j1] = byteVector
							.readUnsignedByte();
					rsInterface.requiredValues[j1] = byteVector
							.readUnsignedWord();
				}
			...
			if (k1 > 0) {
				...
				for (int l1 = 0; l1 < k1; l1++) {
					...
					for (int l4 = 0; l4 < i3; l4++)
						rsInterface.valueIndexArray[l1][l4] = byteVector
								.readUnsignedWord();
			...
			if (rsInterface.type == 0) {
				...
				rsInterface.isMouseoverTriggered = byteVector
						.readUnsignedByte() == 1;
			...
			if (rsInterface.type == 2) {
				...
				rsInterface.isInventoryInterface = byteVector
						.readUnsignedByte() == 1;
	...
	public static void unpackCustom() {
		...
		for (int i = 27000; i < 27676; i++) {
			addClickableText(i, musicNames[(i - 27000)],
					musicNames[(i - 27000)], 0, 65280, 16777215, 162, 11);
		}
		int id = 27000;
