package com.atarx.core.network.login;
...
import com.atarx.core.network.ISAACCipher;
...
public class LoginDecoder extends FrameDecoder {
	...
	private static Client login(Channel channel, ISAACCipher inCipher, ISAACCipher outCipher, int version, String name, String pass, String uid) {
		...
		if (ataratixConstants.STAFF_ONLY) {
			boolean isStaff = false;
			for (String usernames : ataratixConstants.STAFF_MEMBERS) {
		...
		for (String retard : ataratixConstants.BAD_USERNAMES) {
